...
class RequiredCollaborationAllowlistExemptTarget(TypedDict):
    pass

class OptionalCollaborationAllowlistExemptTarget(TypedDict, total=False):
...
class CollaborationAllowlistExemptTarget(RequiredCollaborationAllowlistExemptTarget, OptionalCollaborationAllowlistExemptTarget):
    pass
