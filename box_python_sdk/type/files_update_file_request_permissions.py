...
class RequiredFilesUpdateFileRequestPermissions(TypedDict):
    pass

class OptionalFilesUpdateFileRequestPermissions(TypedDict, total=False):
...
class FilesUpdateFileRequestPermissions(RequiredFilesUpdateFileRequestPermissions, OptionalFilesUpdateFileRequestPermissions):
    pass
