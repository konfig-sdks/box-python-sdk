...
class RequiredSessionTerminationCreateSessionTerminationJobsRequest(TypedDict):
...
class OptionalSessionTerminationCreateSessionTerminationJobsRequest(TypedDict, total=False):
    pass

class SessionTerminationCreateSessionTerminationJobsRequest(RequiredSessionTerminationCreateSessionTerminationJobsRequest, OptionalSessionTerminationCreateSessionTerminationJobsRequest):
    pass
