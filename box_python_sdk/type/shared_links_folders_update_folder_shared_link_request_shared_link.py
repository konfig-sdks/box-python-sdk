...
from box_python_sdk.type.shared_links_folders_update_folder_shared_link_request_shared_link_permissions import SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions

class RequiredSharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink(TypedDict):
    pass

class OptionalSharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink(TypedDict, total=False):
    ...
    permissions: SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions

class SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink(RequiredSharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink, OptionalSharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink):
    pass
