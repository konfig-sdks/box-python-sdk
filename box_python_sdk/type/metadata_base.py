...
RequiredMetadataBase = TypedDict("RequiredMetadataBase", {
    })

OptionalMetadataBase = TypedDict("OptionalMetadataBase", {
...
class MetadataBase(RequiredMetadataBase, OptionalMetadataBase):
    pass
