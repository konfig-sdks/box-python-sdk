...
from box_python_sdk.type.metadata_templates_create_new_template_request_fields_item_options import MetadataTemplatesCreateNewTemplateRequestFieldsItemOptions

class RequiredMetadataTemplatesCreateNewTemplateRequestFieldsItem(TypedDict):
...
class OptionalMetadataTemplatesCreateNewTemplateRequestFieldsItem(TypedDict, total=False):
    ...
    options: MetadataTemplatesCreateNewTemplateRequestFieldsItemOptions

class MetadataTemplatesCreateNewTemplateRequestFieldsItem(RequiredMetadataTemplatesCreateNewTemplateRequestFieldsItem, OptionalMetadataTemplatesCreateNewTemplateRequestFieldsItem):
    pass
