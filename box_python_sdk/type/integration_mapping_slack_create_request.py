...
class RequiredIntegrationMappingSlackCreateRequest(TypedDict):
    partner_item: IntegrationMappingPartnerItemSlack

    box_item: IntegrationMappingBoxItemSlack

class OptionalIntegrationMappingSlackCreateRequest(TypedDict, total=False):
    options: IntegrationMappingSlackOptions

class IntegrationMappingSlackCreateRequest(RequiredIntegrationMappingSlackCreateRequest, OptionalIntegrationMappingSlackCreateRequest):
    pass
