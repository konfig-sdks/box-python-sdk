...
class RequiredStatusSkillCardInvocation(TypedDict):
    # `skill_invocation`
    type: str
...
class OptionalStatusSkillCardInvocation(TypedDict, total=False):
    pass

class StatusSkillCardInvocation(RequiredStatusSkillCardInvocation, OptionalStatusSkillCardInvocation):
    pass
