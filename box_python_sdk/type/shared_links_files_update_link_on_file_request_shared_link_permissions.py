...
class RequiredSharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions(TypedDict):
    pass

class OptionalSharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions(TypedDict, total=False):
...
class SharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions(RequiredSharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions, OptionalSharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions):
    pass
