...
class RequiredPostGroupsRequest(TypedDict):
    # The name of the new group to be created. This name must be unique within the enterprise.
    name: str

class OptionalPostGroupsRequest(TypedDict, total=False):
...
class PostGroupsRequest(RequiredPostGroupsRequest, OptionalPostGroupsRequest):
    pass
