...
class RequiredSkillsUpdateAllBoxSkillCardsRequest(TypedDict):
...
class OptionalSkillsUpdateAllBoxSkillCardsRequest(TypedDict, total=False):
    file_version: SkillsUpdateAllBoxSkillCardsRequestFileVersion

    usage: SkillsUpdateAllBoxSkillCardsRequestUsage

class SkillsUpdateAllBoxSkillCardsRequest(RequiredSkillsUpdateAllBoxSkillCardsRequest, OptionalSkillsUpdateAllBoxSkillCardsRequest):
    pass
