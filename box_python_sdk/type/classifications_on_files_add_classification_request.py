...
class RequiredClassificationsOnFilesAddClassificationRequest(TypedDict):
    pass

class OptionalClassificationsOnFilesAddClassificationRequest(TypedDict, total=False):
...
class ClassificationsOnFilesAddClassificationRequest(RequiredClassificationsOnFilesAddClassificationRequest, OptionalClassificationsOnFilesAddClassificationRequest):
    pass
