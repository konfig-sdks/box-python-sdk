...
class RequiredPostTasksRequest(TypedDict):
    item: PostTasksRequestItem

class OptionalPostTasksRequest(TypedDict, total=False):
...
class PostTasksRequest(RequiredPostTasksRequest, OptionalPostTasksRequest):
    pass
