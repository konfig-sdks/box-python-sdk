...
class RequiredTimelineSkillCardInvocation(TypedDict):
    # `skill_invocation`
    type: str
...
class OptionalTimelineSkillCardInvocation(TypedDict, total=False):
    pass

class TimelineSkillCardInvocation(RequiredTimelineSkillCardInvocation, OptionalTimelineSkillCardInvocation):
    pass
