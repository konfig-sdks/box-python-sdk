...
from box_python_sdk.type.shared_links_web_links_add_link_to_web_link_request_shared_link_permissions import SharedLinksWebLinksAddLinkToWebLinkRequestSharedLinkPermissions

class RequiredSharedLinksWebLinksAddLinkToWebLinkRequestSharedLink(TypedDict):
    pass

class OptionalSharedLinksWebLinksAddLinkToWebLinkRequestSharedLink(TypedDict, total=False):
...
class SharedLinksWebLinksAddLinkToWebLinkRequestSharedLink(RequiredSharedLinksWebLinksAddLinkToWebLinkRequestSharedLink, OptionalSharedLinksWebLinksAddLinkToWebLinkRequestSharedLink):
    pass
