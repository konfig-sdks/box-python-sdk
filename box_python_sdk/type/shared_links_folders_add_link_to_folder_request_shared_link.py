...
from box_python_sdk.type.shared_links_folders_add_link_to_folder_request_shared_link_permissions import SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions

class RequiredSharedLinksFoldersAddLinkToFolderRequestSharedLink(TypedDict):
    pass

class OptionalSharedLinksFoldersAddLinkToFolderRequestSharedLink(TypedDict, total=False):
    ...
    permissions: SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions

class SharedLinksFoldersAddLinkToFolderRequestSharedLink(RequiredSharedLinksFoldersAddLinkToFolderRequestSharedLink, OptionalSharedLinksFoldersAddLinkToFolderRequestSharedLink):
    pass
