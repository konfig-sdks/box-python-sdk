...
class RequiredUploadsSmallFileRequest(TypedDict):
...
class OptionalUploadsSmallFileRequest(TypedDict, total=False):
    pass

class UploadsSmallFileRequest(RequiredUploadsSmallFileRequest, OptionalUploadsSmallFileRequest):
    pass
