...
from box_python_sdk.type.shared_links_files_add_shared_link_to_file_request_shared_link_permissions import SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions

class RequiredSharedLinksFilesAddSharedLinkToFileRequestSharedLink(TypedDict):
    pass

class OptionalSharedLinksFilesAddSharedLinkToFileRequestSharedLink(TypedDict, total=False):
    ...
    permissions: SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions

class SharedLinksFilesAddSharedLinkToFileRequestSharedLink(RequiredSharedLinksFilesAddSharedLinkToFileRequestSharedLink, OptionalSharedLinksFilesAddSharedLinkToFileRequestSharedLink):
    pass
