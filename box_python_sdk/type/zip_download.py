...
from box_python_sdk.type.zip_download_name_conflicts import ZipDownloadNameConflicts

class RequiredZipDownload(TypedDict):
    pass

class OptionalZipDownload(TypedDict, total=False):
    ...
    name_conflicts: ZipDownloadNameConflicts

class ZipDownload(RequiredZipDownload, OptionalZipDownload):
    pass
