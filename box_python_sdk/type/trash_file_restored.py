...
class RequiredTrashFileRestored(TypedDict):
...
class OptionalTrashFileRestored(TypedDict, total=False):
...
class TrashFileRestored(RequiredTrashFileRestored, OptionalTrashFileRestored):
    pass
