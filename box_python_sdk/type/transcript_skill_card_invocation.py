...
class RequiredTranscriptSkillCardInvocation(TypedDict):
    # `skill_invocation`
    type: str
...
class OptionalTranscriptSkillCardInvocation(TypedDict, total=False):
    pass

class TranscriptSkillCardInvocation(RequiredTranscriptSkillCardInvocation, OptionalTranscriptSkillCardInvocation):
    pass
