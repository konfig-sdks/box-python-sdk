...
class RequiredKeywordSkillCardInvocation(TypedDict):
    # `skill_invocation`
    type: str
...
class OptionalKeywordSkillCardInvocation(TypedDict, total=False):
    pass

class KeywordSkillCardInvocation(RequiredKeywordSkillCardInvocation, OptionalKeywordSkillCardInvocation):
    pass
