...
RequiredMetadataInstancesFoldersUpdateInstanceOnFolderRequestItem = TypedDict("RequiredMetadataInstancesFoldersUpdateInstanceOnFolderRequestItem", {
    })

OptionalMetadataInstancesFoldersUpdateInstanceOnFolderRequestItem = TypedDict("OptionalMetadataInstancesFoldersUpdateInstanceOnFolderRequestItem", {
...
class MetadataInstancesFoldersUpdateInstanceOnFolderRequestItem(RequiredMetadataInstancesFoldersUpdateInstanceOnFolderRequestItem, OptionalMetadataInstancesFoldersUpdateInstanceOnFolderRequestItem):
    pass
