...
class RequiredWebLinksUpdateObjectRequestSharedLink(TypedDict):
    pass

class OptionalWebLinksUpdateObjectRequestSharedLink(TypedDict, total=False):
...
class WebLinksUpdateObjectRequestSharedLink(RequiredWebLinksUpdateObjectRequestSharedLink, OptionalWebLinksUpdateObjectRequestSharedLink):
    pass
