...
from box_python_sdk.type.shared_links_files_update_link_on_file_request_shared_link_permissions import SharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions

class RequiredSharedLinksFilesUpdateLinkOnFileRequestSharedLink(TypedDict):
    pass

class OptionalSharedLinksFilesUpdateLinkOnFileRequestSharedLink(TypedDict, total=False):
    ...
    permissions: SharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions

class SharedLinksFilesUpdateLinkOnFileRequestSharedLink(RequiredSharedLinksFilesUpdateLinkOnFileRequestSharedLink, OptionalSharedLinksFilesUpdateLinkOnFileRequestSharedLink):
    pass
