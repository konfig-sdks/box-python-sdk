...
class Activities(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class entries(
                        ...
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['Activity'], typing.List['Activity']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'entries':
                            return super().__new__(
                                cls,
                    ...
                    class errors(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['ActivityFetchError']:
                                return ActivityFetchError
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['ActivityFetchError'], typing.List['ActivityFetchError']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'errors':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'ActivityFetchError':
                            return super().__getitem__(i)
                    __annotations__ = {
                        "entries": entries,
                        "errors": errors,
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["entries", "errors", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entries", "errors", ], str]):
                return super().get_item_oapg(name)
