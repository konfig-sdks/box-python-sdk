...
group.
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class group_type(
                        ...
                        def MANAGED_GROUP(cls):
                            return cls("managed_group")
                        
                        @schemas.classproperty
                        def ALL_USERS_GROUP(cls):
                            return cls("all_users_group")
                    __annotations__ = {
                        "name": name,
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "group_type", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "group_type", ], str]):
