...
class ShieldInformationBarrierReference(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["shield_information_barrier", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["shield_information_barrier", ], str]):
