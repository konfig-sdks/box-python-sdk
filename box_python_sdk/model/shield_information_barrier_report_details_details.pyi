...
class ShieldInformationBarrierReportDetailsDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["folder_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["folder_id", ], str]):
