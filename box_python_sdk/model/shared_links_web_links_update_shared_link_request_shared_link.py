...
class SharedLinksWebLinksUpdateSharedLinkRequestSharedLink(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def permissions() -> typing.Type['SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions']:
                return SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions
            __annotations__ = {
                "access": access,
                "password": password,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["permissions"]) -> 'SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["permissions"]) -> typing.Union['SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        permissions: typing.Union['SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SharedLinksWebLinksUpdateSharedLinkRequestSharedLink':
