...
class TaskAssigneesEntriesItemPermissions(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["can_delete", "can_update", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["can_delete", "can_update", ], str]):
    ...
    ) -> 'TaskAssigneesEntriesItemPermissions':
