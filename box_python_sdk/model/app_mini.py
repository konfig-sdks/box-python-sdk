...
nested under another resource.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["icon_url", "id", "name", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["icon_url", "id", "name", "type", ], str]):
