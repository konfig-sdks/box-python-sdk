...
class Metadatas(
        ...
        class properties:
            ...
            class entries(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MetadataBase']:
                        return MetadataBase
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MetadataBase'], typing.List['MetadataBase']],
                ...
                def __getitem__(self, i: int) -> 'MetadataBase':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entries", "limit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entries", "limit", ], str]):
