                ...
                class properties:
                    ...
                    class entries(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['FileVersionFull']:
                                return FileVersionFull
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['FileVersionFull'], typing.List['FileVersionFull']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'entries':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'FileVersionFull':
                            return super().__getitem__(i)
                    __annotations__ = {
                        "entries": entries,
                    }
