...
class TasksUpdateTaskConfigurationRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "message", "due_at", "completion_rule", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "message", "due_at", "completion_rule", ], str]):
