...
query parameter has been set to `true`.
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_count", "limit", "offset", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_count", "limit", "offset", ], str]):
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class type(
                        ...
                        def SEARCH_RESULTS_WITH_SHARED_LINKS(cls):
                            return cls("search_results_with_shared_links")
                    ...
                    class entries(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['SearchResultWithSharedLink']:
                                return SearchResultWithSharedLink
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['SearchResultWithSharedLink'], typing.List['SearchResultWithSharedLink']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'entries':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'SearchResultWithSharedLink':
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "entries", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "entries", ], str]):
                return super().get_item_oapg(name)
