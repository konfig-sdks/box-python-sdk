...
class ClassificationsAddNewClassificationsRequestItemDataStaticConfigClassification(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ClassificationsAddNewClassificationsRequestItemDataStaticConfigClassification':
