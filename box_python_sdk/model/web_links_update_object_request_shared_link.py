...
class WebLinksUpdateObjectRequestSharedLink(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access", "password", "vanity_name", "unshared_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access", "password", "vanity_name", "unshared_at", ], str]):
    ...
    ) -> 'WebLinksUpdateObjectRequestSharedLink':
