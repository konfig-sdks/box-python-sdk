...
from box_python_sdk.pydantic.metadata_query_fields import MetadataQueryFields
from box_python_sdk.pydantic.metadata_query_order_by import MetadataQueryOrderBy
from box_python_sdk.pydantic.metadata_query_query_params import MetadataQueryQueryParams
...
class MetadataQuery(BaseModel):
    ...
    ancestor_folder_id: str = Field(alias='ancestor_folder_id')
    ...
    query_params_: typing.Optional[MetadataQueryQueryParams] = Field(None, alias='query_params')

    order_by: typing.Optional[MetadataQueryOrderBy] = Field(None, alias='order_by')
    ...
    marker: typing.Optional[str] = Field(None, alias='marker')

    fields: typing.Optional[MetadataQueryFields] = Field(None, alias='fields')
    class Config:
