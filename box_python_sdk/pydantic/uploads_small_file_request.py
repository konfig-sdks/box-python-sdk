...
from box_python_sdk.pydantic.uploads_small_file_request_attributes import UploadsSmallFileRequestAttributes

class UploadsSmallFileRequest(BaseModel):
    attributes: UploadsSmallFileRequestAttributes = Field(alias='attributes')
