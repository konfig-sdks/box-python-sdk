...
from box_python_sdk.pydantic.file_or_folder_scope import FileOrFolderScope
...
class AccessToken(BaseModel):
    ...
    restricted_to: typing.Optional[typing.List[FileOrFolderScope]] = Field(None, alias='restricted_to')
    ...
    issued_token_type: typing.Optional[Literal["urn:ietf:params:oauth:token-type:access_token"]] = Field(None, alias='issued_token_type')
    class Config:
