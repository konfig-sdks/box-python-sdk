...
from box_python_sdk.pydantic.shared_links_web_links_add_link_to_web_link_request_shared_link_permissions import SharedLinksWebLinksAddLinkToWebLinkRequestSharedLinkPermissions

class SharedLinksWebLinksAddLinkToWebLinkRequestSharedLink(BaseModel):
    ...
    permissions: typing.Optional[SharedLinksWebLinksAddLinkToWebLinkRequestSharedLinkPermissions] = Field(None, alias='permissions')
    class Config:
