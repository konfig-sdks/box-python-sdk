...
class DevicePinner(BaseModel):
    # The unique identifier for this device pin.
    id: typing.Optional[str] = Field(None, alias='id')

    # `device_pinner`
    type: typing.Optional[Literal["device_pinner"]] = Field(None, alias='type')
    ...
    product_name: typing.Optional[str] = Field(None, alias='product_name')
    class Config:
