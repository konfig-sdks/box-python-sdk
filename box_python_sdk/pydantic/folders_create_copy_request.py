...
from box_python_sdk.pydantic.folders_create_copy_request_parent import FoldersCreateCopyRequestParent

class FoldersCreateCopyRequest(BaseModel):
    parent: FoldersCreateCopyRequestParent = Field(alias='parent')
