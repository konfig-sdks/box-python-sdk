...
class MetadataInstancesFoldersUpdateInstanceOnFolderRequestItem(BaseModel):
    # The type of change to perform on the template. Some of these are hazardous as they will change existing templates.
    op: typing.Optional[Literal["add", "replace", "remove", "test", "move", "copy"]] = Field(None, alias='op')
