...
from box_python_sdk.pydantic.shared_links_files_update_link_on_file_request_shared_link_permissions import SharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions

class SharedLinksFilesUpdateLinkOnFileRequestSharedLink(BaseModel):
    ...
    permissions: typing.Optional[SharedLinksFilesUpdateLinkOnFileRequestSharedLinkPermissions] = Field(None, alias='permissions')
    class Config:
