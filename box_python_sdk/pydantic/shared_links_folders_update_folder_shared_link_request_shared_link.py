...
from box_python_sdk.pydantic.shared_links_folders_update_folder_shared_link_request_shared_link_permissions import SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions

class SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink(BaseModel):
    ...
    permissions: typing.Optional[SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions] = Field(None, alias='permissions')
    class Config:
