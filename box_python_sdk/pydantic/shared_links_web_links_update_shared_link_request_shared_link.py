...
from box_python_sdk.pydantic.shared_links_web_links_update_shared_link_request_shared_link_permissions import SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions

class SharedLinksWebLinksUpdateSharedLinkRequestSharedLink(BaseModel):
    ...
    permissions: typing.Optional[SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions] = Field(None, alias='permissions')
    class Config:
