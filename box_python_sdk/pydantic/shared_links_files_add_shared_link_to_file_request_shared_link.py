...
from box_python_sdk.pydantic.shared_links_files_add_shared_link_to_file_request_shared_link_permissions import SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions

class SharedLinksFilesAddSharedLinkToFileRequestSharedLink(BaseModel):
    ...
    permissions: typing.Optional[SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions] = Field(None, alias='permissions')
    class Config:
