...
class ClassificationsOnFilesUpdateClassificationMetadataInstanceRequestItem(BaseModel):
    # `replace`
    op: Literal["replace"] = Field(alias='op')

    # Defines classifications  available in the enterprise.
    path: Literal["/Box__Security__Classification__Key"] = Field(alias='path')
