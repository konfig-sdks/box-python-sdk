...
from box_python_sdk.pydantic.web_links_update_object_request_shared_link import WebLinksUpdateObjectRequestSharedLink

class WebLinksUpdateObjectRequest(BaseModel):
    ...
    shared_link: typing.Optional[WebLinksUpdateObjectRequestSharedLink] = Field(None, alias='shared_link')
    class Config:
