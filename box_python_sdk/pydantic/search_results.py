...
SearchResults = typing.Union[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],typing.Union[bool, date, datetime, dict, float, int, list, str, None]]
