...
class BaseApi(api_client.Api):
    ...
    def _move_to_trash_mapped_args(
        self,
        file_id: str,
        file_version_id: str,
    ...
    async def _amove_to_trash_oapg(
        self,
...
class MoveToTrashRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amove_to_trash(
        self,
        file_id: str,
        file_version_id: str,
        if_match: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._move_to_trash_mapped_args(
            file_id=file_id,
            file_version_id=file_version_id,
            if_match=if_match,
        )
        return await self._amove_to_trash_oapg(
    ...
    def move_to_trash(
        ...
        return self._move_to_trash_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class MoveToTrash(BaseApi):
    ...
    async def amove_to_trash(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amove_to_trash(
            file_id=file_id,
            file_version_id=file_version_id,
            if_match=if_match,
            **kwargs,
    ...
    def move_to_trash(
        ...
        raw_response = self.raw.move_to_trash(
            file_id=file_id,
            file_version_id=file_version_id,
            if_match=if_match,
        )
