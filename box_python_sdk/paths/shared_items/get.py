...
class BaseApi(api_client.Api):
    ...
    def _get_by_shared_link_mapped_args(
        self,
        boxapi: str,
    ...
    async def _aget_by_shared_link_oapg(
        self,
...
class GetBySharedLinkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_shared_link(
        self,
        boxapi: str,
        if_none_match: typing.Optional[str] = None,
        fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_by_shared_link_mapped_args(
            boxapi=boxapi,
            if_none_match=if_none_match,
            fields=fields,
        )
        return await self._aget_by_shared_link_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def get_by_shared_link(
        self,
        boxapi: str,
        if_none_match: typing.Optional[str] = None,
        fields: typing.Optional[typing.List[str]] = None,
        ...
        return self._get_by_shared_link_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetBySharedLink(BaseApi):
    ...
    async def aget_by_shared_link(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_shared_link(
            boxapi=boxapi,
            if_none_match=if_none_match,
            fields=fields,
            **kwargs,
    ...
    def get_by_shared_link(
        ...
        raw_response = self.raw.get_by_shared_link(
            boxapi=boxapi,
            if_none_match=if_none_match,
            fields=fields,
        )
