...
from box_python_sdk.model.folder_locks import FolderLocks as FolderLocksSchema

from box_python_sdk.type.folder_locks import FolderLocks
...
from box_python_sdk.pydantic.folder_locks import FolderLocks as FolderLocksPydantic
...
SchemaFor200ResponseBodyApplicationJson = FolderLocksSchema
...
class ListDetails(BaseApi):
    ...
    async def alist_details(
        ...
        **kwargs,
        ...
        if validate:
            return FolderLocksPydantic(**raw_response.body)
        return api_client.construct_model_instance(FolderLocksPydantic, raw_response.body)
