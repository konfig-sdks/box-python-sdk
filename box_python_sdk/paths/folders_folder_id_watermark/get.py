...
class BaseApi(api_client.Api):
    ...
    def _get_folder_watermark_mapped_args(
        self,
        folder_id: str,
    ...
    async def _aget_folder_watermark_oapg(
        self,
    ...
    def _get_folder_watermark_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFolderWatermarkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_folder_watermark(
        self,
        folder_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_folder_watermark_mapped_args(
            folder_id=folder_id,
        )
        return await self._aget_folder_watermark_oapg(
    ...
    def get_folder_watermark(
        ...
        return self._get_folder_watermark_oapg(
            path_params=args.path,
        )

class GetFolderWatermark(BaseApi):
    ...
    async def aget_folder_watermark(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_folder_watermark(
            folder_id=folder_id,
            **kwargs,
        )
        if validate:
    ...
    def get_folder_watermark(
        ...
        raw_response = self.raw.get_folder_watermark(
            folder_id=folder_id,
        )
        if validate:
            return WatermarkPydantic(**raw_response.body)
