...
class BaseApi(api_client.Api):
    ...
    def _remove_folder_watermark_mapped_args(
        self,
        folder_id: str,
    ...
    async def _aremove_folder_watermark_oapg(
        self,
    ...
    def _remove_folder_watermark_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveFolderWatermarkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_folder_watermark(
        self,
        folder_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_folder_watermark_mapped_args(
            folder_id=folder_id,
        )
        return await self._aremove_folder_watermark_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_folder_watermark(
        self,
        folder_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._remove_folder_watermark_oapg(
            path_params=args.path,
        )

class RemoveFolderWatermark(BaseApi):
    ...
    async def aremove_folder_watermark(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_folder_watermark(
            folder_id=folder_id,
            **kwargs,
        )
    ...
    def remove_folder_watermark(
        ...
        raw_response = self.raw.remove_folder_watermark(
            folder_id=folder_id,
        )
