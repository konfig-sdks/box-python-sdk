...
from box_python_sdk.model.groups_update_group_request import GroupsUpdateGroupRequest as GroupsUpdateGroupRequestSchema

from box_python_sdk.type.group_full import GroupFull
from box_python_sdk.type.groups_update_group_request import GroupsUpdateGroupRequest
...
from box_python_sdk.pydantic.groups_update_group_request import GroupsUpdateGroupRequest as GroupsUpdateGroupRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GroupsUpdateGroupRequestSchema


request_body_groups_update_group_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = GroupFullSchema
    ...
    async def _aupdate_group_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_groups_update_group_request.serialize(body, content_type)
...
class UpdateGroupRaw(BaseApi):
    ...
    async def aupdate_group(
        ...
        **kwargs,
        ...
        args = self._update_group_mapped_args(
            group_id=group_id,
        ...
        return await self._aupdate_group_oapg(
            body=args.body,
...
class UpdateGroup(BaseApi):
    ...
    async def aupdate_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_group(
            group_id=group_id,
            description=description,
            name=name,
            provenance=provenance,
    ...
    def update_group(
        ...
        raw_response = self.raw.update_group(
            group_id=group_id,
            description=description,
            name=name,
            provenance=provenance,
