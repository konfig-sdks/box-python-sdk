...
class BaseApi(api_client.Api):
    ...
    def _folder_access_mapped_args(
        self,
        folder_id: str,
    ...
    async def _afolder_access_oapg(
        self,
...
class FolderAccessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afolder_access(
        self,
        folder_id: str,
        fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._folder_access_mapped_args(
            folder_id=folder_id,
            fields=fields,
        )
        return await self._afolder_access_oapg(
    ...
    def folder_access(
        ...
        return self._folder_access_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FolderAccess(BaseApi):
    ...
    async def afolder_access(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afolder_access(
            folder_id=folder_id,
            fields=fields,
            **kwargs,
        )
    ...
    def folder_access(
        ...
        raw_response = self.raw.folder_access(
            folder_id=folder_id,
            fields=fields,
        )
        if validate:
