...
from box_python_sdk.model.tasks_update_task_configuration_request import TasksUpdateTaskConfigurationRequest as TasksUpdateTaskConfigurationRequestSchema

from box_python_sdk.type.tasks_update_task_configuration_request import TasksUpdateTaskConfigurationRequest
...
from box_python_sdk.pydantic.tasks_update_task_configuration_request import TasksUpdateTaskConfigurationRequest as TasksUpdateTaskConfigurationRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TasksUpdateTaskConfigurationRequestSchema


request_body_tasks_update_task_configuration_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TaskSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_task_configuration_mapped_args(
        self,
        task_id: str,
    ...
    async def _aupdate_task_configuration_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_tasks_update_task_configuration_request.serialize(body, content_type)
    ...
    def _update_task_configuration_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateTaskConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_task_configuration(
        self,
        task_id: str,
        action: typing.Optional[str] = None,
        message: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_task_configuration_mapped_args(
            task_id=task_id,
            action=action,
            message=message,
            due_at=due_at,
        ...
        return await self._aupdate_task_configuration_oapg(
            body=args.body,
    ...
    def update_task_configuration(
        ...
        return self._update_task_configuration_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateTaskConfiguration(BaseApi):
    ...
    async def aupdate_task_configuration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_task_configuration(
            task_id=task_id,
            action=action,
            message=message,
            due_at=due_at,
    ...
    def update_task_configuration(
        ...
        raw_response = self.raw.update_task_configuration(
            task_id=task_id,
            action=action,
            message=message,
            due_at=due_at,
