...
class RemoveFileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_file(
        self,
        task_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_file_mapped_args(
            task_id=task_id,
        )
        return await self._aremove_file_oapg(
    ...
    def remove_file(
        ...
        return self._remove_file_oapg(
            path_params=args.path,
        )

class RemoveFile(BaseApi):
    ...
    async def aremove_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_file(
            task_id=task_id,
            **kwargs,
        )
    ...
    def remove_file(
        ...
        raw_response = self.raw.remove_file(
            task_id=task_id,
        )
