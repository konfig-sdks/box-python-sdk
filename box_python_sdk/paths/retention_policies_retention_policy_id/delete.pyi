...
class BaseApi(api_client.Api):
    ...
    def _delete_policy_mapped_args(
        self,
    ...
    async def _adelete_policy_oapg(
        self,
...
class DeletePolicyRaw(BaseApi):
    ...
    async def adelete_policy(
        ...
        **kwargs,
        ...
        args = self._delete_policy_mapped_args(
            retention_policy_id=retention_policy_id,
        )
        return await self._adelete_policy_oapg(
    ...
    def delete_policy(
        ...
        return self._delete_policy_oapg(
            path_params=args.path,
        )
...
class DeletePolicy(BaseApi):
    ...
    async def adelete_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_policy(
            retention_policy_id=retention_policy_id,
            **kwargs,
        )
    ...
    def delete_policy(
        ...
        raw_response = self.raw.delete_policy(
            retention_policy_id=retention_policy_id,
        )
