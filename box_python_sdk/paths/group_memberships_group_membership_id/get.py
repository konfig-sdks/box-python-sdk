...
class BaseApi(api_client.Api):
    ...
    def _get_specific_membership_mapped_args(
        self,
    ...
    async def _aget_specific_membership_oapg(
        self,
    ...
    def _get_specific_membership_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSpecificMembershipRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_membership(
        self,
        group_membership_id: str,
        fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_specific_membership_mapped_args(
            group_membership_id=group_membership_id,
            fields=fields,
        )
        return await self._aget_specific_membership_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_membership(
        self,
        group_membership_id: str,
        fields: typing.Optional[typing.List[str]] = None,
    ) -> typing.Union[
        ...
        return self._get_specific_membership_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSpecificMembership(BaseApi):
    ...
    async def aget_specific_membership(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_membership(
            group_membership_id=group_membership_id,
            fields=fields,
            **kwargs,
        )
    ...
    def get_specific_membership(
        ...
        raw_response = self.raw.get_specific_membership(
            group_membership_id=group_membership_id,
            fields=fields,
        )
        if validate:
