...
class BaseApi(api_client.Api):
    ...
    def _list_file_version_legal_holds_mapped_args(
        self,
        policy_id: str,
    ...
    async def _alist_file_version_legal_holds_oapg(
        self,
    ...
    def _list_file_version_legal_holds_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListFileVersionLegalHoldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_file_version_legal_holds(
        self,
        policy_id: str,
        marker: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_file_version_legal_holds_mapped_args(
            policy_id=policy_id,
            marker=marker,
            limit=limit,
        )
        return await self._alist_file_version_legal_holds_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_file_version_legal_holds(
        self,
        policy_id: str,
        marker: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._list_file_version_legal_holds_oapg(
            query_params=args.query,
        )

class ListFileVersionLegalHolds(BaseApi):
    ...
    async def alist_file_version_legal_holds(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_file_version_legal_holds(
            policy_id=policy_id,
            marker=marker,
            limit=limit,
            **kwargs,
    ...
    def list_file_version_legal_holds(
        ...
        raw_response = self.raw.list_file_version_legal_holds(
            policy_id=policy_id,
            marker=marker,
            limit=limit,
        )
