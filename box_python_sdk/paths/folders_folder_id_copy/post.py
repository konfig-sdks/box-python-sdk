...
from box_python_sdk.model.folders_create_copy_request import FoldersCreateCopyRequest as FoldersCreateCopyRequestSchema
from box_python_sdk.model.folders_create_copy_request_parent import FoldersCreateCopyRequestParent as FoldersCreateCopyRequestParentSchema

from box_python_sdk.type.folders_create_copy_request import FoldersCreateCopyRequest
...
from box_python_sdk.pydantic.folders_create_copy_request_parent import FoldersCreateCopyRequestParent as FoldersCreateCopyRequestParentPydantic
from box_python_sdk.pydantic.folders_create_copy_request import FoldersCreateCopyRequest as FoldersCreateCopyRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FoldersCreateCopyRequestSchema


request_body_folders_create_copy_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FolderFullSchema
    ...
    async def _acreate_copy_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_folders_create_copy_request.serialize(body, content_type)
