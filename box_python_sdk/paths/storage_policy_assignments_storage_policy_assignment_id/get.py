...
class BaseApi(api_client.Api):
    ...
    def _get_specific_assignment_mapped_args(
        self,
    ...
    async def _aget_specific_assignment_oapg(
        self,
    ...
    def _get_specific_assignment_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificAssignmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_assignment(
        self,
        storage_policy_assignment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_assignment_mapped_args(
            storage_policy_assignment_id=storage_policy_assignment_id,
        )
        return await self._aget_specific_assignment_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_assignment(
        self,
        storage_policy_assignment_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_assignment_oapg(
            path_params=args.path,
        )

class GetSpecificAssignment(BaseApi):
    ...
    async def aget_specific_assignment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_assignment(
            storage_policy_assignment_id=storage_policy_assignment_id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_assignment(
        ...
        raw_response = self.raw.get_specific_assignment(
            storage_policy_assignment_id=storage_policy_assignment_id,
        )
        if validate:
            return StoragePolicyAssignmentPydantic(**raw_response.body)
