...
from box_python_sdk.model.shield_information_barrier_segments_create_segment_request import ShieldInformationBarrierSegmentsCreateSegmentRequest as ShieldInformationBarrierSegmentsCreateSegmentRequestSchema
...
from box_python_sdk.type.shield_information_barrier_segments_create_segment_request import ShieldInformationBarrierSegmentsCreateSegmentRequest
...
from box_python_sdk.pydantic.shield_information_barrier_segments_create_segment_request import ShieldInformationBarrierSegmentsCreateSegmentRequest as ShieldInformationBarrierSegmentsCreateSegmentRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ShieldInformationBarrierSegmentsCreateSegmentRequestSchema


request_body_shield_information_barrier_segments_create_segment_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShieldInformationBarrierSegmentSchema
    ...
    async def _acreate_segment_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_shield_information_barrier_segments_create_segment_request.serialize(body, content_type)
