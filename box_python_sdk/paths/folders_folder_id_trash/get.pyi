...
from box_python_sdk.model.trash_folder import TrashFolder as TrashFolderSchema

from box_python_sdk.type.trash_folder import TrashFolder
...
from box_python_sdk.pydantic.trash_folder import TrashFolder as TrashFolderPydantic
...
SchemaFor200ResponseBodyApplicationJson = TrashFolderSchema
...
class GetdFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agetd_folder(
        self,
        folder_id: str,
        fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._getd_folder_mapped_args(
            folder_id=folder_id,
            fields=fields,
        )
        return await self._agetd_folder_oapg(
    ...
    def getd_folder(
        ...
        return self._getd_folder_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetdFolder(BaseApi):
    ...
    async def agetd_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agetd_folder(
            folder_id=folder_id,
            fields=fields,
            **kwargs,
        )
        if validate:
            return TrashFolderPydantic(**raw_response.body)
        return api_client.construct_model_instance(TrashFolderPydantic, raw_response.body)
    ...
    def getd_folder(
        ...
        raw_response = self.raw.getd_folder(
            folder_id=folder_id,
            fields=fields,
        )
        if validate:
