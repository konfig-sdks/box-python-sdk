...
class BaseApi(api_client.Api):
    ...
    def _permanently_remove_folder_mapped_args(
        self,
        folder_id: str,
    ...
    async def _apermanently_remove_folder_oapg(
        self,
    ...
    def _permanently_remove_folder_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PermanentlyRemoveFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apermanently_remove_folder(
        self,
        folder_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._permanently_remove_folder_mapped_args(
            folder_id=folder_id,
        )
        return await self._apermanently_remove_folder_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def permanently_remove_folder(
        self,
        folder_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._permanently_remove_folder_oapg(
            path_params=args.path,
        )

class PermanentlyRemoveFolder(BaseApi):
    ...
    async def apermanently_remove_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apermanently_remove_folder(
            folder_id=folder_id,
            **kwargs,
        )
    ...
    def permanently_remove_folder(
        ...
        raw_response = self.raw.permanently_remove_folder(
            folder_id=folder_id,
        )
