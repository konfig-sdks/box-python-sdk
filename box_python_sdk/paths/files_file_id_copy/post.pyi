...
from box_python_sdk.model.files_create_copy_request_parent import FilesCreateCopyRequestParent as FilesCreateCopyRequestParentSchema
from box_python_sdk.model.files_create_copy_request import FilesCreateCopyRequest as FilesCreateCopyRequestSchema
from box_python_sdk.model.file_full import FileFull as FileFullSchema

from box_python_sdk.type.file_full import FileFull
from box_python_sdk.type.files_create_copy_request import FilesCreateCopyRequest
from box_python_sdk.type.files_create_copy_request_parent import FilesCreateCopyRequestParent
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.files_create_copy_request import FilesCreateCopyRequest as FilesCreateCopyRequestPydantic
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic
from box_python_sdk.pydantic.files_create_copy_request_parent import FilesCreateCopyRequestParent as FilesCreateCopyRequestParentPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FilesCreateCopyRequestSchema


request_body_files_create_copy_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = FileFullSchema
    ...
    async def _acreate_copy_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_files_create_copy_request.serialize(body, content_type)
...
class CreateCopyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_copy(
        self,
        parent: FilesCreateCopyRequestParent,
        file_id: str,
        version: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_copy_mapped_args(
            parent=parent,
            file_id=file_id,
            version=version,
            name=name,
        ...
        return await self._acreate_copy_oapg(
            body=args.body,
    ...
    def create_copy(
        ...
        return self._create_copy_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateCopy(BaseApi):
    ...
    async def acreate_copy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_copy(
            parent=parent,
            file_id=file_id,
            version=version,
            name=name,
    ...
    def create_copy(
        ...
        raw_response = self.raw.create_copy(
            parent=parent,
            file_id=file_id,
            version=version,
            name=name,
