...
from box_python_sdk.model.workflows import Workflows as WorkflowsSchema

from box_python_sdk.type.workflows import Workflows
...
from box_python_sdk.pydantic.workflows import Workflows as WorkflowsPydantic

from . import path

# Query params
FolderIdSchema = schemas.StrSchema
TriggerTypeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'trigger_type': typing.Union[TriggerTypeSchema, str, ],
...
request_query_trigger_type = api_client.QueryParameter(
    name="trigger_type",
    style=api_client.ParameterStyle.FORM,
    schema=TriggerTypeSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WorkflowsSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflows_mapped_args(
        ...
        if trigger_type is not None:
            _query_params["trigger_type"] = trigger_type
...
class WorkflowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflows(
        self,
        folder_id: str,
        trigger_type: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._workflows_mapped_args(
            folder_id=folder_id,
            trigger_type=trigger_type,
            limit=limit,
            marker=marker,
        )
        return await self._aworkflows_oapg(
...
class Workflows(BaseApi):
    ...
    async def aworkflows(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aworkflows(
            folder_id=folder_id,
            trigger_type=trigger_type,
            limit=limit,
            marker=marker,
        ...
        if validate:
            return RootModel[WorkflowsPydantic](raw_response.body).root
        return api_client.construct_model_instance(WorkflowsPydantic, raw_response.body)
    ...
    def workflows(
        ...
        raw_response = self.raw.workflows(
            folder_id=folder_id,
            trigger_type=trigger_type,
            limit=limit,
            marker=marker,
