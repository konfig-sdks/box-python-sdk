...
from box_python_sdk.model.shared_links_folders_remove_from_folder_request import SharedLinksFoldersRemoveFromFolderRequest as SharedLinksFoldersRemoveFromFolderRequestSchema

from box_python_sdk.type.folder_full import FolderFull
from box_python_sdk.type.shared_links_folders_remove_from_folder_request import SharedLinksFoldersRemoveFromFolderRequest
...
from box_python_sdk.pydantic.shared_links_folders_remove_from_folder_request import SharedLinksFoldersRemoveFromFolderRequest as SharedLinksFoldersRemoveFromFolderRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SharedLinksFoldersRemoveFromFolderRequestSchema


request_body_shared_links_folders_remove_from_folder_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_from_folder_mapped_args(
        self,
        folder_id: str,
        fields: str,
    ...
    async def _aremove_from_folder_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_shared_links_folders_remove_from_folder_request.serialize(body, content_type)
...
class RemoveFromFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_folder(
        self,
        folder_id: str,
        fields: str,
        shared_link: typing.Optional[typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        **kwargs,
        ...
        args = self._remove_from_folder_mapped_args(
            folder_id=folder_id,
            fields=fields,
            shared_link=shared_link,
        )
        return await self._aremove_from_folder_oapg(
            body=args.body,
    ...
    def remove_from_folder(
        ...
        return self._remove_from_folder_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class RemoveFromFolder(BaseApi):
    ...
    async def aremove_from_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_folder(
            folder_id=folder_id,
            fields=fields,
            shared_link=shared_link,
            **kwargs,
    ...
    def remove_from_folder(
        ...
        raw_response = self.raw.remove_from_folder(
            folder_id=folder_id,
            fields=fields,
            shared_link=shared_link,
        )
