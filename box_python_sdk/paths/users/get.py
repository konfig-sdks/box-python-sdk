...
from box_python_sdk.model.users import Users as UsersSchema

from box_python_sdk.type.users import Users
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.users import Users as UsersPydantic
...
class UserTypeSchema(
    ...
    def EXTERNAL(cls):
        return cls("external")
ExternalAppUserIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'external_app_user_id': typing.Union[ExternalAppUserIdSchema, str, ],
...
request_query_external_app_user_id = api_client.QueryParameter(
    name="external_app_user_id",
    style=api_client.ParameterStyle.FORM,
    schema=ExternalAppUserIdSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _users_mapped_args(
        ...
        if external_app_user_id is not None:
            _query_params["external_app_user_id"] = external_app_user_id
    ...
    async def _ausers_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_external_app_user_id,
...
class Users(BaseApi):
    ...
    async def ausers(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[UsersPydantic](raw_response.body).root
