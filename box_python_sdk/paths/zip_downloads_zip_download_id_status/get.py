...
from box_python_sdk.model.zip_download_status import ZipDownloadStatus as ZipDownloadStatusSchema
from box_python_sdk.model.client_error import ClientError as ClientErrorSchema

from box_python_sdk.type.zip_download_status import ZipDownloadStatus
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.zip_download_status import ZipDownloadStatus as ZipDownloadStatusPydantic
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic

from . import path

# Path params
ZipDownloadIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'zip_download_id': typing.Union[ZipDownloadIdSchema, str, ],
    }
)
...
request_path_zip_download_id = api_client.PathParameter(
    name="zip_download_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ZipDownloadIdSchema,
    required=True,
)
_auth = [
    'OAuth2Security',
]
SchemaFor200ResponseBodyApplicationJson = ZipDownloadStatusSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ZipDownloadStatus
...
class BaseApi(api_client.Api):
    ...
    def _get_status_mapped_args(
        ...
        _path_params = {}
        if zip_download_id is not None:
            _path_params["zip_download_id"] = zip_download_id
...
class GetStatus(BaseApi):
    ...
    async def aget_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ZipDownloadStatusPydantic:
        raw_response = await self.raw.aget_status(
            zip_download_id=zip_download_id,
            **kwargs,
        )
        if validate:
            return ZipDownloadStatusPydantic(**raw_response.body)
        return api_client.construct_model_instance(ZipDownloadStatusPydantic, raw_response.body)
