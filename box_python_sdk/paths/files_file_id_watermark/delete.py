...
class BaseApi(api_client.Api):
    ...
    def _remove_watermark_mapped_args(
        self,
        file_id: str,
    ...
    async def _aremove_watermark_oapg(
        self,
...
class RemoveWatermarkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_watermark(
        self,
        file_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_watermark_mapped_args(
            file_id=file_id,
        )
        return await self._aremove_watermark_oapg(
    ...
    def remove_watermark(
        ...
        return self._remove_watermark_oapg(
            path_params=args.path,
        )

class RemoveWatermark(BaseApi):
    ...
    async def aremove_watermark(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_watermark(
            file_id=file_id,
            **kwargs,
        )
    ...
    def remove_watermark(
        ...
        raw_response = self.raw.remove_watermark(
            file_id=file_id,
        )
