...
class BaseApi(api_client.Api):
    ...
    def _get_classification_metadata_mapped_args(
        self,
        folder_id: str,
    ...
    async def _aget_classification_metadata_oapg(
        self,
    ...
    def _get_classification_metadata_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetClassificationMetadataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_classification_metadata(
        self,
        folder_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_classification_metadata_mapped_args(
            folder_id=folder_id,
        )
        return await self._aget_classification_metadata_oapg(
    ...
    def get_classification_metadata(
        ...
        return self._get_classification_metadata_oapg(
            path_params=args.path,
        )

class GetClassificationMetadata(BaseApi):
    ...
    async def aget_classification_metadata(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_classification_metadata(
            folder_id=folder_id,
            **kwargs,
        )
        if validate:
    ...
    def get_classification_metadata(
        ...
        raw_response = self.raw.get_classification_metadata(
            folder_id=folder_id,
        )
        if validate:
            return ClassificationPydantic(**raw_response.body)
