...
request_path_shield_information_barrier_id = api_client.PathParameter(
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        ...
        if shield_information_barrier_id is not None:
            _path_params["shield_information_barrier_id"] = shield_information_barrier_id
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_shield_information_barrier_id,
        ):
