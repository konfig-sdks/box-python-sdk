...
class BaseApi(api_client.Api):
    ...
    def _get_link_info_mapped_args(
        self,
        web_link_id: str,
        fields: str,
    ...
    async def _aget_link_info_oapg(
        self,
...
class GetLinkInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_link_info(
        self,
        web_link_id: str,
        fields: str,
        **kwargs,
        ...
        args = self._get_link_info_mapped_args(
            web_link_id=web_link_id,
            fields=fields,
        )
        return await self._aget_link_info_oapg(
    ...
    def get_link_info(
        ...
        return self._get_link_info_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetLinkInfo(BaseApi):
    ...
    async def aget_link_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_link_info(
            web_link_id=web_link_id,
            fields=fields,
            **kwargs,
        )
    ...
    def get_link_info(
        ...
        raw_response = self.raw.get_link_info(
            web_link_id=web_link_id,
            fields=fields,
        )
        if validate:
