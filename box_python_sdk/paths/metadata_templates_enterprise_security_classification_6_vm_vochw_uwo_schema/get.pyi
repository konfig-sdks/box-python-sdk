...
class BaseApi(api_client.Api):
    ...
    def _list_all_classifications_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_all_classifications_oapg(
        self,
    ...
    def _list_all_classifications_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ListAllClassificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_classifications(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_all_classifications_mapped_args(
        )
        return await self._alist_all_classifications_oapg(
            **kwargs,
        )
    ...
    def list_all_classifications(
        ...
        return self._list_all_classifications_oapg(
        )

class ListAllClassifications(BaseApi):
    ...
    async def alist_all_classifications(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_all_classifications(
            **kwargs,
        )
        if validate:
    ...
    def list_all_classifications(
        ...
        raw_response = self.raw.list_all_classifications(
        )
        if validate:
            return ClassificationTemplatePydantic(**raw_response.body)
        return api_client.construct_model_instance(ClassificationTemplatePydantic, raw_response.body)
