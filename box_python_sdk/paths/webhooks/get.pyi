...
from box_python_sdk.model.webhooks import Webhooks as WebhooksSchema

from box_python_sdk.type.webhooks import Webhooks
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.webhooks import Webhooks as WebhooksPydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksSchema
...
class WebhooksRaw(BaseApi):
    ...
    async def awebhooks(
        ...
        **kwargs,
        ...
        args = self._webhooks_mapped_args(
            marker=marker,
            limit=limit,
        )
        return await self._awebhooks_oapg(
...
class Webhooks(BaseApi):
    ...
    async def awebhooks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awebhooks(
            marker=marker,
            limit=limit,
            **kwargs,
        )
        if validate:
            return RootModel[WebhooksPydantic](raw_response.body).root
        return api_client.construct_model_instance(WebhooksPydantic, raw_response.body)
    ...
    def webhooks(
        ...
        raw_response = self.raw.webhooks(
            marker=marker,
            limit=limit,
        )
        if validate:
