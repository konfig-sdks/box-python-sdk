...
from box_python_sdk.model.session_termination_create_termination_jobs_request import SessionTerminationCreateTerminationJobsRequest as SessionTerminationCreateTerminationJobsRequestSchema
...
from box_python_sdk.model.session_termination_create_termination_jobs_request_group_ids import SessionTerminationCreateTerminationJobsRequestGroupIds as SessionTerminationCreateTerminationJobsRequestGroupIdsSchema

from box_python_sdk.type.session_termination_create_termination_jobs_request import SessionTerminationCreateTerminationJobsRequest
from box_python_sdk.type.session_termination_message import SessionTerminationMessage
from box_python_sdk.type.session_termination_create_termination_jobs_request_group_ids import SessionTerminationCreateTerminationJobsRequestGroupIds
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.session_termination_create_termination_jobs_request import SessionTerminationCreateTerminationJobsRequest as SessionTerminationCreateTerminationJobsRequestPydantic
...
from box_python_sdk.pydantic.session_termination_create_termination_jobs_request_group_ids import SessionTerminationCreateTerminationJobsRequestGroupIds as SessionTerminationCreateTerminationJobsRequestGroupIdsPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = SessionTerminationCreateTerminationJobsRequestSchema


request_body_session_termination_create_termination_jobs_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_termination_jobs_mapped_args(
        self,
        ...
        if group_ids is not None:
            _body["group_ids"] = group_ids
        args.body = _body
        return args

    async def _acreate_termination_jobs_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_session_termination_create_termination_jobs_request.serialize(body, content_type)
    ...
    def _create_termination_jobs_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateTerminationJobsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_termination_jobs(
        self,
        group_ids: SessionTerminationCreateTerminationJobsRequestGroupIds,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._create_termination_jobs_mapped_args(
            group_ids=group_ids,
        )
        return await self._acreate_termination_jobs_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_termination_jobs(
        self,
        group_ids: SessionTerminationCreateTerminationJobsRequestGroupIds,
    ) -> typing.Union[
        ApiResponseFor202,
        ...
        return self._create_termination_jobs_oapg(
            body=args.body,
        )

class CreateTerminationJobs(BaseApi):
    ...
    async def acreate_termination_jobs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_termination_jobs(
            group_ids=group_ids,
            **kwargs,
        )
        if validate:
    ...
    def create_termination_jobs(
        ...
        raw_response = self.raw.create_termination_jobs(
            group_ids=group_ids,
        )
        if validate:
            return SessionTerminationMessagePydantic(**raw_response.body)
