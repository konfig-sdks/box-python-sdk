...
class BaseApi(api_client.Api):
    ...
    def _list_on_folder_mapped_args(
        self,
        folder_id: str,
    ...
    async def _alist_on_folder_oapg(
        self,
...
class ListOnFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_on_folder(
        self,
        folder_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_on_folder_mapped_args(
            folder_id=folder_id,
        )
        return await self._alist_on_folder_oapg(
    ...
    def list_on_folder(
        ...
        return self._list_on_folder_oapg(
            path_params=args.path,
        )

class ListOnFolder(BaseApi):
    ...
    async def alist_on_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_on_folder(
            folder_id=folder_id,
            **kwargs,
        )
        if validate:
    ...
    def list_on_folder(
        ...
        raw_response = self.raw.list_on_folder(
            folder_id=folder_id,
        )
        if validate:
            return MetadatasPydantic(**raw_response.body)
