...
class BaseApi(api_client.Api):
    ...
    def _remove_existing_mapped_args(
        self,
        user_id: str,
    ...
    async def _aremove_existing_oapg(
        self,
...
class RemoveExistingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_existing(
        self,
        user_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_existing_mapped_args(
            user_id=user_id,
        )
        return await self._aremove_existing_oapg(
    ...
    def remove_existing(
        ...
        return self._remove_existing_oapg(
            path_params=args.path,
        )

class RemoveExisting(BaseApi):
    ...
    async def aremove_existing(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_existing(
            user_id=user_id,
            **kwargs,
        )
    ...
    def remove_existing(
        ...
        raw_response = self.raw.remove_existing(
            user_id=user_id,
        )
