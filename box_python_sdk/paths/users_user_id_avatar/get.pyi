...
class GetImageRaw(BaseApi):
    ...
    async def aget_image(
        ...
        **kwargs,
        ...
        args = self._get_image_mapped_args(
            user_id=user_id,
        )
        return await self._aget_image_oapg(
...
class GetImage(BaseApi):
    ...
    async def aget_image(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_image(
            user_id=user_id,
            **kwargs,
        )
        if validate:
    ...
    def get_image(
        ...
        raw_response = self.raw.get_image(
            user_id=user_id,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
