...
from box_python_sdk.model.sign_requests import SignRequests as SignRequestsSchema

from box_python_sdk.type.sign_requests import SignRequests
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.sign_requests import SignRequests as SignRequestsPydantic
...
SchemaFor200ResponseBodyApplicationJson = SignRequestsSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[SignRequestsPydantic](raw_response.body).root
        return api_client.construct_model_instance(SignRequestsPydantic, raw_response.body)
