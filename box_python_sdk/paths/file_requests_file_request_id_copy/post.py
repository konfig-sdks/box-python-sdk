...
from box_python_sdk.model.file_request_copy_request import FileRequestCopyRequest as FileRequestCopyRequestSchema

from box_python_sdk.type.file_request import FileRequest
from box_python_sdk.type.file_request_copy_request import FileRequestCopyRequest
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.file_request_copy_request import FileRequestCopyRequest as FileRequestCopyRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FileRequestCopyRequestSchema


request_body_file_request_copy_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _copy_request_to_folder_mapped_args(
        self,
        folder: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        file_request_id: str,
    ...
    async def _acopy_request_to_folder_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_file_request_copy_request.serialize(body, content_type)
    ...
    def _copy_request_to_folder_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CopyRequestToFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acopy_request_to_folder(
        self,
        folder: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        file_request_id: str,
        title: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._copy_request_to_folder_mapped_args(
            folder=folder,
        ...
        return await self._acopy_request_to_folder_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def copy_request_to_folder(
        self,
        folder: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        file_request_id: str,
        title: typing.Optional[str] = None,
        ...
        return self._copy_request_to_folder_oapg(
            body=args.body,
            path_params=args.path,
        )

class CopyRequestToFolder(BaseApi):
    ...
    async def acopy_request_to_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acopy_request_to_folder(
            folder=folder,
            file_request_id=file_request_id,
            title=title,
            description=description,
    ...
    def copy_request_to_folder(
        ...
        raw_response = self.raw.copy_request_to_folder(
            folder=folder,
            file_request_id=file_request_id,
            title=title,
            description=description,
