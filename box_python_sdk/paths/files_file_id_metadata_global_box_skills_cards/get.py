...
class BaseApi(api_client.Api):
    ...
    def _list_box_skill_cards_mapped_args(
        self,
        file_id: str,
    ...
    async def _alist_box_skill_cards_oapg(
        self,
    ...
    def _list_box_skill_cards_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListBoxSkillCardsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_box_skill_cards(
        self,
        file_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_box_skill_cards_mapped_args(
            file_id=file_id,
        )
        return await self._alist_box_skill_cards_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_box_skill_cards(
        self,
        file_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_box_skill_cards_oapg(
            path_params=args.path,
        )

class ListBoxSkillCards(BaseApi):
    ...
    async def alist_box_skill_cards(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_box_skill_cards(
            file_id=file_id,
            **kwargs,
        )
        if validate:
    ...
    def list_box_skill_cards(
        ...
        raw_response = self.raw.list_box_skill_cards(
            file_id=file_id,
        )
        if validate:
            return SkillCardsMetadataPydantic(**raw_response.body)
