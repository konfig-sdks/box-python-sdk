...
class BaseApi(api_client.Api):
    ...
    def _remove_box_skill_cards_mapped_args(
        self,
        file_id: str,
    ...
    async def _aremove_box_skill_cards_oapg(
        self,
    ...
    def _remove_box_skill_cards_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveBoxSkillCardsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_box_skill_cards(
        self,
        file_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_box_skill_cards_mapped_args(
            file_id=file_id,
        )
        return await self._aremove_box_skill_cards_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_box_skill_cards(
        self,
        file_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._remove_box_skill_cards_oapg(
            path_params=args.path,
        )

class RemoveBoxSkillCards(BaseApi):
    ...
    async def aremove_box_skill_cards(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_box_skill_cards(
            file_id=file_id,
            **kwargs,
        )
    ...
    def remove_box_skill_cards(
        ...
        raw_response = self.raw.remove_box_skill_cards(
            file_id=file_id,
        )
