...
from box_python_sdk.model.comments_update_message_request import CommentsUpdateMessageRequest as CommentsUpdateMessageRequestSchema

from box_python_sdk.type.comment_full import CommentFull
from box_python_sdk.type.comments_update_message_request import CommentsUpdateMessageRequest
...
from box_python_sdk.pydantic.comments_update_message_request import CommentsUpdateMessageRequest as CommentsUpdateMessageRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'comment_id': typing.Union[CommentIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = CommentsUpdateMessageRequestSchema


request_body_comments_update_message_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CommentFullSchema
    ...
    async def _aupdate_message_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_comments_update_message_request.serialize(body, content_type)
