...
from box_python_sdk.model.shield_information_barrier_reference import ShieldInformationBarrierReference as ShieldInformationBarrierReferenceSchema
from box_python_sdk.model.shield_information_barrier_report import ShieldInformationBarrierReport as ShieldInformationBarrierReportSchema

from box_python_sdk.type.shield_information_barrier_base import ShieldInformationBarrierBase
from box_python_sdk.type.shield_information_barrier_reference import ShieldInformationBarrierReference
from box_python_sdk.type.shield_information_barrier_report import ShieldInformationBarrierReport
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.shield_information_barrier_reference import ShieldInformationBarrierReference as ShieldInformationBarrierReferencePydantic
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic
from box_python_sdk.pydantic.shield_information_barrier_report import ShieldInformationBarrierReport as ShieldInformationBarrierReportPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShieldInformationBarrierReferenceSchema


request_body_shield_information_barrier_reference = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShieldInformationBarrierReportSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ShieldInformationBarrierReport
    ...
    async def _acreate_report_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_shield_information_barrier_reference.serialize(body, content_type)
...
class CreateReport(BaseApi):
    ...
    async def acreate_report(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShieldInformationBarrierReportPydantic:
        raw_response = await self.raw.acreate_report(
            shield_information_barrier=shield_information_barrier,
            **kwargs,
        )
        if validate:
            return RootModel[ShieldInformationBarrierReportPydantic](raw_response.body).root
        return api_client.construct_model_instance(ShieldInformationBarrierReportPydantic, raw_response.body)
