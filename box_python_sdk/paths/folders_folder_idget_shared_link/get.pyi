...
class BaseApi(api_client.Api):
    ...
    def _get_shared_link_for_folder_mapped_args(
        self,
        folder_id: str,
        fields: str,
    ...
    async def _aget_shared_link_for_folder_oapg(
        self,
    ...
    def _get_shared_link_for_folder_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSharedLinkForFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_shared_link_for_folder(
        self,
        folder_id: str,
        fields: str,
        **kwargs,
        ...
        args = self._get_shared_link_for_folder_mapped_args(
            folder_id=folder_id,
            fields=fields,
        )
        return await self._aget_shared_link_for_folder_oapg(
    ...
    def get_shared_link_for_folder(
        ...
        return self._get_shared_link_for_folder_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSharedLinkForFolder(BaseApi):
    ...
    async def aget_shared_link_for_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_shared_link_for_folder(
            folder_id=folder_id,
            fields=fields,
            **kwargs,
        )
    ...
    def get_shared_link_for_folder(
        ...
        raw_response = self.raw.get_shared_link_for_folder(
            folder_id=folder_id,
            fields=fields,
        )
        if validate:
