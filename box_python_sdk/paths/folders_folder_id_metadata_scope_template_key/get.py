...
class BaseApi(api_client.Api):
    ...
    def _get_folder_metadata_instance_mapped_args(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
    ...
    async def _aget_folder_metadata_instance_oapg(
        self,
    ...
    def _get_folder_metadata_instance_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFolderMetadataInstanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_folder_metadata_instance(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        **kwargs,
        ...
        args = self._get_folder_metadata_instance_mapped_args(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
        return await self._aget_folder_metadata_instance_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_folder_metadata_instance(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        ...
        return self._get_folder_metadata_instance_oapg(
            path_params=args.path,
        )

class GetFolderMetadataInstance(BaseApi):
    ...
    async def aget_folder_metadata_instance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_folder_metadata_instance(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
            **kwargs,
    ...
    def get_folder_metadata_instance(
        ...
        raw_response = self.raw.get_folder_metadata_instance(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
