...
from box_python_sdk.model.metadata_instances_folders_update_instance_on_folder_request import MetadataInstancesFoldersUpdateInstanceOnFolderRequest as MetadataInstancesFoldersUpdateInstanceOnFolderRequestSchema
...
from box_python_sdk.type.metadata_instances_folders_update_instance_on_folder_request import MetadataInstancesFoldersUpdateInstanceOnFolderRequest
...
from box_python_sdk.pydantic.metadata_instances_folders_update_instance_on_folder_request import MetadataInstancesFoldersUpdateInstanceOnFolderRequest as MetadataInstancesFoldersUpdateInstanceOnFolderRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = MetadataInstancesFoldersUpdateInstanceOnFolderRequestSchema


request_body_metadata_instances_folders_update_instance_on_folder_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_instance_on_folder_mapped_args(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        body: typing.Optional[MetadataInstancesFoldersUpdateInstanceOnFolderRequest] = None,
    ...
    async def _aupdate_instance_on_folder_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_metadata_instances_folders_update_instance_on_folder_request.serialize(body, content_type)
    ...
    def _update_instance_on_folder_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateInstanceOnFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_instance_on_folder(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        ...
        **kwargs,
        ...
        args = self._update_instance_on_folder_mapped_args(
            body=body,
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
        return await self._aupdate_instance_on_folder_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_instance_on_folder(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        ...
        return self._update_instance_on_folder_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateInstanceOnFolder(BaseApi):
    ...
    async def aupdate_instance_on_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_instance_on_folder(
            body=body,
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
    ...
    def update_instance_on_folder(
        ...
        raw_response = self.raw.update_instance_on_folder(
            body=body,
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
