...
from box_python_sdk.model.metadata_instances_folders_apply_template_request import MetadataInstancesFoldersApplyTemplateRequest as MetadataInstancesFoldersApplyTemplateRequestSchema
...
from box_python_sdk.type.metadata_instances_folders_apply_template_request import MetadataInstancesFoldersApplyTemplateRequest
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.metadata_instances_folders_apply_template_request import MetadataInstancesFoldersApplyTemplateRequest as MetadataInstancesFoldersApplyTemplateRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MetadataInstancesFoldersApplyTemplateRequestSchema


request_body_metadata_instances_folders_apply_template_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MetadataFullSchema
...
class BaseApi(api_client.Api):
    ...
    def _apply_template_mapped_args(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
    ...
    async def _aapply_template_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_metadata_instances_folders_apply_template_request.serialize(body, content_type)
...
class ApplyTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aapply_template(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        **kwargs,
        ...
        args = self._apply_template_mapped_args(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
        return await self._aapply_template_oapg(
            body=args.body,
    ...
    def apply_template(
        ...
        return self._apply_template_oapg(
            body=args.body,
            path_params=args.path,
        )

class ApplyTemplate(BaseApi):
    ...
    async def aapply_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aapply_template(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
            **kwargs,
    ...
    def apply_template(
        ...
        raw_response = self.raw.apply_template(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
