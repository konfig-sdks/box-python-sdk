...
class BaseApi(api_client.Api):
    ...
    def _remove_instance_mapped_args(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
    ...
    async def _aremove_instance_oapg(
        self,
...
class RemoveInstanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_instance(
        self,
        folder_id: str,
        scope: str,
        template_key: str,
        **kwargs,
        ...
        args = self._remove_instance_mapped_args(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
        return await self._aremove_instance_oapg(
    ...
    def remove_instance(
        ...
        return self._remove_instance_oapg(
            path_params=args.path,
        )

class RemoveInstance(BaseApi):
    ...
    async def aremove_instance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_instance(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
            **kwargs,
    ...
    def remove_instance(
        ...
        raw_response = self.raw.remove_instance(
            folder_id=folder_id,
            scope=scope,
            template_key=template_key,
        )
