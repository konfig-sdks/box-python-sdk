...
class BaseApi(api_client.Api):
    ...
    def _delete_slack_mapping_mapped_args(
        self,
    ...
    async def _adelete_slack_mapping_oapg(
        self,
    ...
    def _delete_slack_mapping_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteSlackMappingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_slack_mapping(
        self,
        integration_mapping_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_slack_mapping_mapped_args(
            integration_mapping_id=integration_mapping_id,
        )
        return await self._adelete_slack_mapping_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_slack_mapping(
        self,
        integration_mapping_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_slack_mapping_oapg(
            path_params=args.path,
        )

class DeleteSlackMapping(BaseApi):
    ...
    async def adelete_slack_mapping(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_slack_mapping(
            integration_mapping_id=integration_mapping_id,
            **kwargs,
        )
    ...
    def delete_slack_mapping(
        ...
        raw_response = self.raw.delete_slack_mapping(
            integration_mapping_id=integration_mapping_id,
        )
