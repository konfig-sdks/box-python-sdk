...
class BaseApi(api_client.Api):
    ...
    def _remove_classification_mapped_args(
        self,
        file_id: str,
    ...
    async def _aremove_classification_oapg(
        self,
    ...
    def _remove_classification_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveClassificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_classification(
        self,
        file_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_classification_mapped_args(
            file_id=file_id,
        )
        return await self._aremove_classification_oapg(
    ...
    def remove_classification(
        ...
        return self._remove_classification_oapg(
            path_params=args.path,
        )

class RemoveClassification(BaseApi):
    ...
    async def aremove_classification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_classification(
            file_id=file_id,
            **kwargs,
        )
    ...
    def remove_classification(
        ...
        raw_response = self.raw.remove_classification(
            file_id=file_id,
        )
