...
from box_python_sdk.model.shared_links_web_links_remove_shared_link_request import SharedLinksWebLinksRemoveSharedLinkRequest as SharedLinksWebLinksRemoveSharedLinkRequestSchema

from box_python_sdk.type.web_link import WebLink
from box_python_sdk.type.shared_links_web_links_remove_shared_link_request import SharedLinksWebLinksRemoveSharedLinkRequest
...
from box_python_sdk.pydantic.shared_links_web_links_remove_shared_link_request import SharedLinksWebLinksRemoveSharedLinkRequest as SharedLinksWebLinksRemoveSharedLinkRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SharedLinksWebLinksRemoveSharedLinkRequestSchema


request_body_shared_links_web_links_remove_shared_link_request = api_client.RequestBody(
    content={
    ...
    async def _aremove_shared_link_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_shared_links_web_links_remove_shared_link_request.serialize(body, content_type)
