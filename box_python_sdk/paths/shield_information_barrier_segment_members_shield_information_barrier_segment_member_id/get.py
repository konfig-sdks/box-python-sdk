...
# Path params
ShieldInformationBarrierSegmentMemberIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'shield_information_barrier_segment_member_id': typing.Union[ShieldInformationBarrierSegmentMemberIdSchema, str, ],
    }
)
...
request_path_shield_information_barrier_segment_member_id = api_client.PathParameter(
    name="shield_information_barrier_segment_member_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ShieldInformationBarrierSegmentMemberIdSchema,
    required=True,
)
_auth = [
    'OAuth2Security',
]
SchemaFor200ResponseBodyApplicationJson = ShieldInformationBarrierSegmentMemberSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        ...
        _path_params = {}
        if shield_information_barrier_segment_member_id is not None:
            _path_params["shield_information_barrier_segment_member_id"] = shield_information_barrier_segment_member_id
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_shield_information_barrier_segment_member_id,
        ):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        args = self._get_by_id_mapped_args(
            shield_information_barrier_segment_member_id=shield_information_barrier_segment_member_id,
        )
