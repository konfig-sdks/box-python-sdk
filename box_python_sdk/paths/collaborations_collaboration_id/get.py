...
class BaseApi(api_client.Api):
    ...
    def _get_single_collaboration_mapped_args(
        self,
    ...
    async def _aget_single_collaboration_oapg(
        self,
    ...
    def _get_single_collaboration_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSingleCollaborationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_collaboration(
        self,
        collaboration_id: str,
        fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_single_collaboration_mapped_args(
            collaboration_id=collaboration_id,
            fields=fields,
        )
        return await self._aget_single_collaboration_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_single_collaboration(
        self,
        collaboration_id: str,
        fields: typing.Optional[typing.List[str]] = None,
    ) -> typing.Union[
        ...
        return self._get_single_collaboration_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSingleCollaboration(BaseApi):
    ...
    async def aget_single_collaboration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_collaboration(
            collaboration_id=collaboration_id,
            fields=fields,
            **kwargs,
        )
    ...
    def get_single_collaboration(
        ...
        raw_response = self.raw.get_single_collaboration(
            collaboration_id=collaboration_id,
            fields=fields,
        )
        if validate:
