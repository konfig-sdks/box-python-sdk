...
from box_python_sdk.model.shared_links_folders_add_link_to_folder_request import SharedLinksFoldersAddLinkToFolderRequest as SharedLinksFoldersAddLinkToFolderRequestSchema
from box_python_sdk.model.shared_links_folders_add_link_to_folder_request_shared_link import SharedLinksFoldersAddLinkToFolderRequestSharedLink as SharedLinksFoldersAddLinkToFolderRequestSharedLinkSchema

from box_python_sdk.type.shared_links_folders_add_link_to_folder_request import SharedLinksFoldersAddLinkToFolderRequest
from box_python_sdk.type.folder_full import FolderFull
from box_python_sdk.type.shared_links_folders_add_link_to_folder_request_shared_link import SharedLinksFoldersAddLinkToFolderRequestSharedLink
...
from box_python_sdk.pydantic.shared_links_folders_add_link_to_folder_request_shared_link import SharedLinksFoldersAddLinkToFolderRequestSharedLink as SharedLinksFoldersAddLinkToFolderRequestSharedLinkPydantic
from box_python_sdk.pydantic.shared_links_folders_add_link_to_folder_request import SharedLinksFoldersAddLinkToFolderRequest as SharedLinksFoldersAddLinkToFolderRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SharedLinksFoldersAddLinkToFolderRequestSchema


request_body_shared_links_folders_add_link_to_folder_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_link_to_folder_mapped_args(
        self,
        folder_id: str,
        fields: str,
        shared_link: typing.Optional[SharedLinksFoldersAddLinkToFolderRequestSharedLink] = None,
    ...
    async def _aadd_link_to_folder_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_shared_links_folders_add_link_to_folder_request.serialize(body, content_type)
...
class AddLinkToFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_link_to_folder(
        self,
        folder_id: str,
        fields: str,
        shared_link: typing.Optional[SharedLinksFoldersAddLinkToFolderRequestSharedLink] = None,
        **kwargs,
        ...
        args = self._add_link_to_folder_mapped_args(
            folder_id=folder_id,
            fields=fields,
            shared_link=shared_link,
        )
        return await self._aadd_link_to_folder_oapg(
            body=args.body,
    ...
    def add_link_to_folder(
        ...
        return self._add_link_to_folder_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddLinkToFolder(BaseApi):
    ...
    async def aadd_link_to_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_link_to_folder(
            folder_id=folder_id,
            fields=fields,
            shared_link=shared_link,
            **kwargs,
    ...
    def add_link_to_folder(
        ...
        raw_response = self.raw.add_link_to_folder(
            folder_id=folder_id,
            fields=fields,
            shared_link=shared_link,
        )
