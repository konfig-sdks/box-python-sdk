...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    'RequestOptionalHeaderParams',
    {
        ...
        'x-rep-hints': typing.Union[XRepHintsSchema, None, str, ],
    },
    total=False
)
...
request_header_x_rep_hints = api_client.HeaderParameter(
    name="x-rep-hints",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XRepHintsSchema,
)
# Path params
...
SchemaFor415ResponseBodyApplicationJson = ClientErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_details_mapped_args(
        ...
        x_rep_hints: typing.Optional[typing.Optional[str]] = None,
        ...
        if x_rep_hints is not None:
            _header_params["x-rep-hints"] = x_rep_hints
