...
class DeleteFileRaw(BaseApi):
    ...
    async def adelete_file(
        ...
        **kwargs,
        ...
        args = self._delete_file_mapped_args(
            file_id=file_id,
            if_match=if_match,
        )
        return await self._adelete_file_oapg(
...
class DeleteFile(BaseApi):
    ...
    async def adelete_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_file(
            file_id=file_id,
            if_match=if_match,
            **kwargs,
        )
    ...
    def delete_file(
        ...
        raw_response = self.raw.delete_file(
            file_id=file_id,
            if_match=if_match,
        )
