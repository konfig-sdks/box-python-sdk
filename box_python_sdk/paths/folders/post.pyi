...
from box_python_sdk.model.post_folders_request import PostFoldersRequest as PostFoldersRequestSchema
from box_python_sdk.model.post_folders_request_parent import PostFoldersRequestParent as PostFoldersRequestParentSchema

from box_python_sdk.type.post_folders_request import PostFoldersRequest
...
from box_python_sdk.pydantic.post_folders_request import PostFoldersRequest as PostFoldersRequestPydantic
from box_python_sdk.pydantic.folder_full import FolderFull as FolderFullPydantic
from box_python_sdk.pydantic.post_folders_request_parent import PostFoldersRequestParent as PostFoldersRequestParentPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostFoldersRequestSchema


request_body_post_folders_request = api_client.RequestBody(
    content={
    ...
    async def _afolders_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_post_folders_request.serialize(body, content_type)
...
class FoldersRaw(BaseApi):
    ...
    async def afolders(
        ...
        **kwargs,
        ...
        args = self._folders_mapped_args(
            name=name,
            parent=parent,
        ...
        return await self._afolders_oapg(
            body=args.body,
...
class Folders(BaseApi):
    ...
    async def afolders(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afolders(
            name=name,
            parent=parent,
            folder_upload_email=folder_upload_email,
            sync_state=sync_state,
