...
class BaseApi(api_client.Api):
    ...
    def _unassign_policy_mapped_args(
        self,
    ...
    async def _aunassign_policy_oapg(
        self,
...
class UnassignPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunassign_policy(
        self,
        legal_hold_policy_assignment_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unassign_policy_mapped_args(
            legal_hold_policy_assignment_id=legal_hold_policy_assignment_id,
        )
        return await self._aunassign_policy_oapg(
    ...
    def unassign_policy(
        ...
        return self._unassign_policy_oapg(
            path_params=args.path,
        )

class UnassignPolicy(BaseApi):
    ...
    async def aunassign_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunassign_policy(
            legal_hold_policy_assignment_id=legal_hold_policy_assignment_id,
            **kwargs,
        )
    ...
    def unassign_policy(
        ...
        raw_response = self.raw.unassign_policy(
            legal_hold_policy_assignment_id=legal_hold_policy_assignment_id,
        )
