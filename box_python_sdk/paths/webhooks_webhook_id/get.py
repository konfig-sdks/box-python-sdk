...
class BaseApi(api_client.Api):
    ...
    def _get_specific_webhook_mapped_args(
        self,
        webhook_id: str,
    ...
    async def _aget_specific_webhook_oapg(
        self,
    ...
    def _get_specific_webhook_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificWebhookRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_webhook(
        self,
        webhook_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_webhook_mapped_args(
            webhook_id=webhook_id,
        )
        return await self._aget_specific_webhook_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_webhook(
        self,
        webhook_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_webhook_oapg(
            path_params=args.path,
        )

class GetSpecificWebhook(BaseApi):
    ...
    async def aget_specific_webhook(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_webhook(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_webhook(
        ...
        raw_response = self.raw.get_specific_webhook(
            webhook_id=webhook_id,
        )
        if validate:
            return RootModel[WebhookPydantic](raw_response.body).root
