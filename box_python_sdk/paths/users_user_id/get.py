...
class BaseApi(api_client.Api):
    ...
    def _get_user_info_mapped_args(
        self,
        user_id: str,
    ...
    async def _aget_user_info_oapg(
        self,
...
class GetUserInfoRaw(BaseApi):
    ...
    async def aget_user_info(
        ...
        **kwargs,
        ...
        args = self._get_user_info_mapped_args(
            user_id=user_id,
            fields=fields,
        )
        return await self._aget_user_info_oapg(
...
class GetUserInfo(BaseApi):
    ...
    async def aget_user_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_info(
            user_id=user_id,
            fields=fields,
            **kwargs,
        )
    ...
    def get_user_info(
        ...
        raw_response = self.raw.get_user_info(
            user_id=user_id,
            fields=fields,
        )
        if validate:
