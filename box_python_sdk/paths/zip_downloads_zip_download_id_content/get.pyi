...
class BaseApi(api_client.Api):
    ...
    def _get_content_by_id_mapped_args(
        self,
        zip_download_id: str,
    ...
    async def _aget_content_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        host = self._get_host_oapg('get_content_by_id', _servers, host_index)
...
class GetContentByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_content_by_id(
        self,
        zip_download_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_content_by_id_mapped_args(
            zip_download_id=zip_download_id,
        )
        return await self._aget_content_by_id_oapg(
    ...
    def get_content_by_id(
        ...
        return self._get_content_by_id_oapg(
            path_params=args.path,
        )

class GetContentById(BaseApi):
    ...
    async def aget_content_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_content_by_id(
            zip_download_id=zip_download_id,
            **kwargs,
        )
        if validate:
    ...
    def get_content_by_id(
        ...
        raw_response = self.raw.get_content_by_id(
            zip_download_id=zip_download_id,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
