...
from box_python_sdk.model.sign_template import SignTemplate as SignTemplateSchema

from box_python_sdk.type.sign_template import SignTemplate
...
from box_python_sdk.pydantic.sign_template import SignTemplate as SignTemplatePydantic
...
SchemaFor200ResponseBodyApplicationJson = SignTemplateSchema
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/sign_templates/{template_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SignTemplatePydantic:
        raw_response = await self.raw.aget_details(
            template_id=template_id,
            **kwargs,
        )
        if validate:
            return RootModel[SignTemplatePydantic](raw_response.body).root
        return api_client.construct_model_instance(SignTemplatePydantic, raw_response.body)
