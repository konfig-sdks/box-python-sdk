...
from box_python_sdk.model.legal_hold_policies import LegalHoldPolicies as LegalHoldPoliciesSchema
from box_python_sdk.model.client_error import ClientError as ClientErrorSchema

from box_python_sdk.type.legal_hold_policies import LegalHoldPolicies
...
from box_python_sdk.pydantic.legal_hold_policies import LegalHoldPolicies as LegalHoldPoliciesPydantic
...
SchemaFor200ResponseBodyApplicationJson = LegalHoldPoliciesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LegalHoldPolicies
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[LegalHoldPoliciesPydantic](raw_response.body).root
        return api_client.construct_model_instance(LegalHoldPoliciesPydantic, raw_response.body)
