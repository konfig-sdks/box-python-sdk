...
from box_python_sdk.model.shared_links_files_add_shared_link_to_file_request_shared_link import SharedLinksFilesAddSharedLinkToFileRequestSharedLink as SharedLinksFilesAddSharedLinkToFileRequestSharedLinkSchema
from box_python_sdk.model.client_error import ClientError as ClientErrorSchema
from box_python_sdk.model.shared_links_files_add_shared_link_to_file_request import SharedLinksFilesAddSharedLinkToFileRequest as SharedLinksFilesAddSharedLinkToFileRequestSchema
from box_python_sdk.model.file_full import FileFull as FileFullSchema

from box_python_sdk.type.file_full import FileFull
from box_python_sdk.type.shared_links_files_add_shared_link_to_file_request import SharedLinksFilesAddSharedLinkToFileRequest
from box_python_sdk.type.shared_links_files_add_shared_link_to_file_request_shared_link import SharedLinksFilesAddSharedLinkToFileRequestSharedLink
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.shared_links_files_add_shared_link_to_file_request import SharedLinksFilesAddSharedLinkToFileRequest as SharedLinksFilesAddSharedLinkToFileRequestPydantic
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic
from box_python_sdk.pydantic.shared_links_files_add_shared_link_to_file_request_shared_link import SharedLinksFilesAddSharedLinkToFileRequestSharedLink as SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SharedLinksFilesAddSharedLinkToFileRequestSchema


request_body_shared_links_files_add_shared_link_to_file_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_shared_link_to_file_mapped_args(
        self,
        file_id: str,
        fields: str,
        shared_link: typing.Optional[SharedLinksFilesAddSharedLinkToFileRequestSharedLink] = None,
    ...
    async def _aadd_shared_link_to_file_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_shared_links_files_add_shared_link_to_file_request.serialize(body, content_type)
    ...
    def _add_shared_link_to_file_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddSharedLinkToFileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_shared_link_to_file(
        self,
        file_id: str,
        fields: str,
        shared_link: typing.Optional[SharedLinksFilesAddSharedLinkToFileRequestSharedLink] = None,
        **kwargs,
        ...
        args = self._add_shared_link_to_file_mapped_args(
            file_id=file_id,
            fields=fields,
            shared_link=shared_link,
        )
        return await self._aadd_shared_link_to_file_oapg(
            body=args.body,
    ...
    def add_shared_link_to_file(
        ...
        return self._add_shared_link_to_file_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddSharedLinkToFile(BaseApi):
    ...
    async def aadd_shared_link_to_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_shared_link_to_file(
            file_id=file_id,
            fields=fields,
            shared_link=shared_link,
            **kwargs,
    ...
    def add_shared_link_to_file(
        ...
        raw_response = self.raw.add_shared_link_to_file(
            file_id=file_id,
            fields=fields,
            shared_link=shared_link,
        )
