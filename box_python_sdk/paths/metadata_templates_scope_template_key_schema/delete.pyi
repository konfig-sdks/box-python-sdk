...
class BaseApi(api_client.Api):
    ...
    def _delete_schema_mapped_args(
        self,
        scope: str,
        template_key: str,
    ...
    async def _adelete_schema_oapg(
        self,
...
class DeleteSchemaRaw(BaseApi):
    ...
    async def adelete_schema(
        ...
        **kwargs,
        ...
        args = self._delete_schema_mapped_args(
            scope=scope,
            template_key=template_key,
        )
        return await self._adelete_schema_oapg(
    ...
    def delete_schema(
        ...
        return self._delete_schema_oapg(
            path_params=args.path,
        )

class DeleteSchema(BaseApi):
    ...
    async def adelete_schema(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_schema(
            scope=scope,
            template_key=template_key,
            **kwargs,
        )
    ...
    def delete_schema(
        ...
        raw_response = self.raw.delete_schema(
            scope=scope,
            template_key=template_key,
        )
