...
class BaseApi(api_client.Api):
    ...
    def _remove_upload_session_mapped_args(
        self,
    ...
    async def _aremove_upload_session_oapg(
        self,
        ...
        **kwargs,
        ...
        host = self._get_host_oapg('remove_upload_session', _servers, host_index)
    ...
    def _remove_upload_session_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveUploadSessionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_upload_session(
        self,
        upload_session_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_upload_session_mapped_args(
            upload_session_id=upload_session_id,
        )
        return await self._aremove_upload_session_oapg(
    ...
    def remove_upload_session(
        ...
        return self._remove_upload_session_oapg(
            path_params=args.path,
        )

class RemoveUploadSession(BaseApi):
    ...
    async def aremove_upload_session(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_upload_session(
            upload_session_id=upload_session_id,
            **kwargs,
        )
    ...
    def remove_upload_session(
        ...
        raw_response = self.raw.remove_upload_session(
            upload_session_id=upload_session_id,
        )
