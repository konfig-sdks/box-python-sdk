...
from box_python_sdk.model.folders_update_folder_request_tags import FoldersUpdateFolderRequestTags as FoldersUpdateFolderRequestTagsSchema
from box_python_sdk.model.folder_full import FolderFull as FolderFullSchema
from box_python_sdk.model.folders_update_folder_request import FoldersUpdateFolderRequest as FoldersUpdateFolderRequestSchema
from box_python_sdk.model.folders_update_folder_request_parent import FoldersUpdateFolderRequestParent as FoldersUpdateFolderRequestParentSchema
from box_python_sdk.model.folders_update_folder_request_collections import FoldersUpdateFolderRequestCollections as FoldersUpdateFolderRequestCollectionsSchema

from box_python_sdk.type.folders_update_folder_request import FoldersUpdateFolderRequest
...
from box_python_sdk.pydantic.folders_update_folder_request import FoldersUpdateFolderRequest as FoldersUpdateFolderRequestPydantic
from box_python_sdk.pydantic.folders_update_folder_request_parent import FoldersUpdateFolderRequestParent as FoldersUpdateFolderRequestParentPydantic
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic
from box_python_sdk.pydantic.folders_update_folder_request_tags import FoldersUpdateFolderRequestTags as FoldersUpdateFolderRequestTagsPydantic
from box_python_sdk.pydantic.folder_full import FolderFull as FolderFullPydantic
from box_python_sdk.pydantic.folders_update_folder_request_collections import FoldersUpdateFolderRequestCollections as FoldersUpdateFolderRequestCollectionsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FoldersUpdateFolderRequestSchema


request_body_folders_update_folder_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_folder_mapped_args(
        self,
        folder_id: str,
        tags: typing.Optional[FoldersUpdateFolderRequestTags] = None,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        sync_state: typing.Optional[str] = None,
        can_non_owners_invite: typing.Optional[bool] = None,
        parent: typing.Optional[FoldersUpdateFolderRequestParent] = None,
        shared_link: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        folder_upload_email: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        is_collaboration_restricted_to_enterprise: typing.Optional[bool] = None,
        collections: typing.Optional[FoldersUpdateFolderRequestCollections] = None,
        can_non_owners_view_collaborators: typing.Optional[bool] = None,
        ...
        if sync_state is not None:
            _body["sync_state"] = sync_state
        if can_non_owners_invite is not None:
            _body["can_non_owners_invite"] = can_non_owners_invite
        if parent is not None:
            _body["parent"] = parent
        if shared_link is not None:
            _body["shared_link"] = shared_link
        if folder_upload_email is not None:
            _body["folder_upload_email"] = folder_upload_email
        if is_collaboration_restricted_to_enterprise is not None:
            _body["is_collaboration_restricted_to_enterprise"] = is_collaboration_restricted_to_enterprise
        if collections is not None:
            _body["collections"] = collections
        if can_non_owners_view_collaborators is not None:
            _body["can_non_owners_view_collaborators"] = can_non_owners_view_collaborators
        args.body = _body
    ...
    async def _aupdate_folder_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_folders_update_folder_request.serialize(body, content_type)
...
class UpdateFolderRaw(BaseApi):
    ...
    async def aupdate_folder(
        ...
        **kwargs,
        ...
        args = self._update_folder_mapped_args(
            folder_id=folder_id,
            tags=tags,
        ...
        return await self._aupdate_folder_oapg(
            body=args.body,
    ...
    def update_folder(
        ...
        return self._update_folder_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class UpdateFolder(BaseApi):
    ...
    async def aupdate_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_folder(
            folder_id=folder_id,
            tags=tags,
            description=description,
            name=name,
    ...
    def update_folder(
        ...
        raw_response = self.raw.update_folder(
            folder_id=folder_id,
            tags=tags,
            description=description,
            name=name,
