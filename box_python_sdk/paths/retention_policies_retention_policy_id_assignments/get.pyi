...
from box_python_sdk.model.retention_policy_assignments import RetentionPolicyAssignments as RetentionPolicyAssignmentsSchema
from box_python_sdk.model.client_error import ClientError as ClientErrorSchema

from box_python_sdk.type.retention_policy_assignments import RetentionPolicyAssignments
...
from box_python_sdk.pydantic.retention_policy_assignments import RetentionPolicyAssignments as RetentionPolicyAssignmentsPydantic
...
SchemaFor200ResponseBodyApplicationJson = RetentionPolicyAssignmentsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RetentionPolicyAssignments
...
class BaseApi(api_client.Api):
    ...
    def _list_all_assignments_mapped_args(
        self,
    ...
    async def _alist_all_assignments_oapg(
        self,
    ...
    def _list_all_assignments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListAllAssignmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_assignments(
        self,
        retention_policy_id: str,
        type: typing.Optional[str] = None,
        fields: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._list_all_assignments_mapped_args(
        ...
        return await self._alist_all_assignments_oapg(
    ...
    def list_all_assignments(
        ...
        return self._list_all_assignments_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListAllAssignments(BaseApi):
    ...
    async def alist_all_assignments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RetentionPolicyAssignmentsPydantic:
        raw_response = await self.raw.alist_all_assignments(
            retention_policy_id=retention_policy_id,
            type=type,
            fields=fields,
            marker=marker,
        ...
        if validate:
            return RootModel[RetentionPolicyAssignmentsPydantic](raw_response.body).root
        return api_client.construct_model_instance(RetentionPolicyAssignmentsPydantic, raw_response.body)
    ...
    def list_all_assignments(
        ...
        raw_response = self.raw.list_all_assignments(
            retention_policy_id=retention_policy_id,
            type=type,
            fields=fields,
            marker=marker,
