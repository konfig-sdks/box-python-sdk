...
from box_python_sdk.model.trash_file import TrashFile as TrashFileSchema

from box_python_sdk.type.trash_file import TrashFile
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.trash_file import TrashFile as TrashFilePydantic
...
SchemaFor200ResponseBodyApplicationJson = TrashFileSchema
...
class GetFile(BaseApi):
    ...
    async def aget_file(
        ...
        **kwargs,
        ...
        if validate:
            return TrashFilePydantic(**raw_response.body)
        return api_client.construct_model_instance(TrashFilePydantic, raw_response.body)
