...
class BaseApi(api_client.Api):
    ...
    def _permanently_remove_file_mapped_args(
        self,
        file_id: str,
    ...
    async def _apermanently_remove_file_oapg(
        self,
    ...
    def _permanently_remove_file_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PermanentlyRemoveFileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apermanently_remove_file(
        self,
        file_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._permanently_remove_file_mapped_args(
            file_id=file_id,
        )
        return await self._apermanently_remove_file_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def permanently_remove_file(
        self,
        file_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._permanently_remove_file_oapg(
            path_params=args.path,
        )

class PermanentlyRemoveFile(BaseApi):
    ...
    async def apermanently_remove_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apermanently_remove_file(
            file_id=file_id,
            **kwargs,
        )
    ...
    def permanently_remove_file(
        ...
        raw_response = self.raw.permanently_remove_file(
            file_id=file_id,
        )
