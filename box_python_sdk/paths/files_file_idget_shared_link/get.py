...
class BaseApi(api_client.Api):
    ...
    def _get_shared_link_info_mapped_args(
        self,
        file_id: str,
        fields: str,
    ...
    async def _aget_shared_link_info_oapg(
        self,
    ...
    def _get_shared_link_info_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSharedLinkInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_shared_link_info(
        self,
        file_id: str,
        fields: str,
        **kwargs,
        ...
        args = self._get_shared_link_info_mapped_args(
            file_id=file_id,
            fields=fields,
        )
        return await self._aget_shared_link_info_oapg(
    ...
    def get_shared_link_info(
        ...
        return self._get_shared_link_info_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSharedLinkInfo(BaseApi):
    ...
    async def aget_shared_link_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_shared_link_info(
            file_id=file_id,
            fields=fields,
            **kwargs,
        )
    ...
    def get_shared_link_info(
        ...
        raw_response = self.raw.get_shared_link_info(
            file_id=file_id,
            fields=fields,
        )
        if validate:
