...
SchemaFor200ResponseBodyApplicationJson = SignRequestSchema
...
class BaseApi(api_client.Api):
    ...
    def _cancel_request_mapped_args(
        self,
        sign_request_id: str,
    ...
    async def _acancel_request_oapg(
        self,
...
class CancelRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_request(
        self,
        sign_request_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._cancel_request_mapped_args(
            sign_request_id=sign_request_id,
        )
        return await self._acancel_request_oapg(
...
class CancelRequest(BaseApi):
    ...
    async def acancel_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_request(
            sign_request_id=sign_request_id,
            **kwargs,
        )
        if validate:
    ...
    def cancel_request(
        ...
        raw_response = self.raw.cancel_request(
            sign_request_id=sign_request_id,
        )
        if validate:
            return RootModel[SignRequestPydantic](raw_response.body).root
