...
from box_python_sdk.model.uploads_file_content_update_request import UploadsFileContentUpdateRequest as UploadsFileContentUpdateRequestSchema
from box_python_sdk.model.files import Files as FilesSchema
from box_python_sdk.model.uploads_file_content_update_request_attributes import UploadsFileContentUpdateRequestAttributes as UploadsFileContentUpdateRequestAttributesSchema

from box_python_sdk.type.uploads_file_content_update_request_attributes import UploadsFileContentUpdateRequestAttributes
from box_python_sdk.type.uploads_file_content_update_request import UploadsFileContentUpdateRequest
...
from box_python_sdk.pydantic.uploads_file_content_update_request_attributes import UploadsFileContentUpdateRequestAttributes as UploadsFileContentUpdateRequestAttributesPydantic
from box_python_sdk.pydantic.uploads_file_content_update_request import UploadsFileContentUpdateRequest as UploadsFileContentUpdateRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = UploadsFileContentUpdateRequestSchema


request_body_uploads_file_content_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FilesSchema
...
class BaseApi(api_client.Api):
    ...
    def _file_content_update_mapped_args(
        self,
        file_id: str,
    ...
    async def _afile_content_update_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_uploads_file_content_update_request.serialize(body, content_type)
            if 'fields' in serialized_data:
                _fields = serialized_data['fields']
            elif 'body' in serialized_data:
                _body = serialized_data['body']
    
        host = self._get_host_oapg('file_content_update', _servers, host_index)
...
class FileContentUpdateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afile_content_update(
        self,
        file_id: str,
        attributes: UploadsFileContentUpdateRequestAttributes,
        file: typing.IO,
        ...
        **kwargs,
        ...
        args = self._file_content_update_mapped_args(
            file_id=file_id,
        ...
        return await self._afile_content_update_oapg(
            body=args.body,
    ...
    def file_content_update(
        ...
        return self._file_content_update_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class FileContentUpdate(BaseApi):
    ...
    async def afile_content_update(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afile_content_update(
            file_id=file_id,
            attributes=attributes,
            file=file,
            if_match=if_match,
    ...
    def file_content_update(
        ...
        raw_response = self.raw.file_content_update(
            file_id=file_id,
            attributes=attributes,
            file=file,
            if_match=if_match,
