...
AccessTokenSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'access_token': typing.Union[AccessTokenSchema, str, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    ...
    def _file_content_get_mapped_args(
        self,
        file_id: str,
        ...
        if access_token is not None:
            _query_params["access_token"] = access_token
    ...
    async def _afile_content_get_oapg(
        self,
...
class FileContentGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afile_content_get(
        self,
        file_id: str,
        range: typing.Optional[str] = None,
        boxapi: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._file_content_get_mapped_args(
            file_id=file_id,
            range=range,
            boxapi=boxapi,
            version=version,
        ...
        return await self._afile_content_get_oapg(
    ...
    def file_content_get(
        ...
        return self._file_content_get_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class FileContentGet(BaseApi):
    ...
    async def afile_content_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afile_content_get(
            file_id=file_id,
            range=range,
            boxapi=boxapi,
            version=version,
    ...
    def file_content_get(
        ...
        raw_response = self.raw.file_content_get(
            file_id=file_id,
            range=range,
            boxapi=boxapi,
            version=version,
