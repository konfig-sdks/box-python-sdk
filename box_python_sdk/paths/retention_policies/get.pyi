...
from box_python_sdk.model.retention_policies import RetentionPolicies as RetentionPoliciesSchema

from box_python_sdk.type.retention_policies import RetentionPolicies
from box_python_sdk.type.client_error import ClientError

from ...api_client import Dictionary
from box_python_sdk.pydantic.retention_policies import RetentionPolicies as RetentionPoliciesPydantic
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic

# Query params
PolicyNameSchema = schemas.StrSchema


class PolicyTypeSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
CreatedByUserIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'policy_name': typing.Union[PolicyNameSchema, str, ],
        'policy_type': typing.Union[PolicyTypeSchema, str, ],
        'created_by_user_id': typing.Union[CreatedByUserIdSchema, str, ],
...
request_query_policy_name = api_client.QueryParameter(
    name="policy_name",
...
request_query_created_by_user_id = api_client.QueryParameter(
    name="created_by_user_id",
    style=api_client.ParameterStyle.FORM,
    schema=CreatedByUserIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = RetentionPoliciesSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_all_mapped_args(
        ...
        if policy_name is not None:
            _query_params["policy_name"] = policy_name
        if policy_type is not None:
            _query_params["policy_type"] = policy_type
        if created_by_user_id is not None:
            _query_params["created_by_user_id"] = created_by_user_id
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_policy_name,
            request_query_policy_type,
            request_query_created_by_user_id,
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[RetentionPoliciesPydantic](raw_response.body).root
        return api_client.construct_model_instance(RetentionPoliciesPydantic, raw_response.body)
