...
from box_python_sdk.model.retention_policies_create_policy_request import RetentionPoliciesCreatePolicyRequest as RetentionPoliciesCreatePolicyRequestSchema
from box_python_sdk.model.user_mini import UserMini as UserMiniSchema
from box_python_sdk.model.retention_policy import RetentionPolicy as RetentionPolicySchema

from box_python_sdk.type.retention_policies_create_policy_request import RetentionPoliciesCreatePolicyRequest
...
from box_python_sdk.pydantic.retention_policies_create_policy_request import RetentionPoliciesCreatePolicyRequest as RetentionPoliciesCreatePolicyRequestPydantic
from box_python_sdk.pydantic.user_mini import UserMini as UserMiniPydantic

# body param
SchemaForRequestBodyApplicationJson = RetentionPoliciesCreatePolicyRequestSchema


request_body_retention_policies_create_policy_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = RetentionPolicySchema
...
class BaseApi(api_client.Api):
    ...
    def _create_policy_mapped_args(
        ...
        retention_type: typing.Optional[str] = None,
        can_owner_extend_retention: typing.Optional[bool] = None,
        are_owners_notified: typing.Optional[bool] = None,
        custom_notification_recipients: typing.Optional[typing.List[UserMini]] = None,
    ...
    async def _acreate_policy_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_retention_policies_create_policy_request.serialize(body, content_type)
