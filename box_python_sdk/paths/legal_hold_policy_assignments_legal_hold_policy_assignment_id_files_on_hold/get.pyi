...
class BaseApi(api_client.Api):
    ...
    def _list_file_versions_mapped_args(
        self,
    ...
    async def _alist_file_versions_oapg(
        self,
...
class ListFileVersionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_file_versions(
        self,
        legal_hold_policy_assignment_id: str,
        marker: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_file_versions_mapped_args(
            legal_hold_policy_assignment_id=legal_hold_policy_assignment_id,
            marker=marker,
            limit=limit,
            fields=fields,
        )
        return await self._alist_file_versions_oapg(
    ...
    def list_file_versions(
        ...
        return self._list_file_versions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListFileVersions(BaseApi):
    ...
    async def alist_file_versions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_file_versions(
            legal_hold_policy_assignment_id=legal_hold_policy_assignment_id,
            marker=marker,
            limit=limit,
            fields=fields,
    ...
    def list_file_versions(
        ...
        raw_response = self.raw.list_file_versions(
            legal_hold_policy_assignment_id=legal_hold_policy_assignment_id,
            marker=marker,
            limit=limit,
            fields=fields,
