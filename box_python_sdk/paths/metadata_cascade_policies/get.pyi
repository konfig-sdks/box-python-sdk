...
from box_python_sdk.model.metadata_cascade_policies import MetadataCascadePolicies as MetadataCascadePoliciesSchema

from box_python_sdk.type.client_error import ClientError
from box_python_sdk.type.metadata_cascade_policies import MetadataCascadePolicies

from ...api_client import Dictionary
from box_python_sdk.pydantic.client_error import ClientError as ClientErrorPydantic
from box_python_sdk.pydantic.metadata_cascade_policies import MetadataCascadePolicies as MetadataCascadePoliciesPydantic

# Query params
FolderIdSchema = schemas.StrSchema
OwnerEnterpriseIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'owner_enterprise_id': typing.Union[OwnerEnterpriseIdSchema, str, ],
...
request_query_owner_enterprise_id = api_client.QueryParameter(
    name="owner_enterprise_id",
    style=api_client.ParameterStyle.FORM,
    schema=OwnerEnterpriseIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = MetadataCascadePoliciesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MetadataCascadePolicies
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        self,
        folder_id: str,
        owner_enterprise_id: typing.Optional[str] = None,
        ...
        if owner_enterprise_id is not None:
            _query_params["owner_enterprise_id"] = owner_enterprise_id
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_owner_enterprise_id,
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MetadataCascadePoliciesPydantic:
        ...
        if validate:
            return RootModel[MetadataCascadePoliciesPydantic](raw_response.body).root
        return api_client.construct_model_instance(MetadataCascadePoliciesPydantic, raw_response.body)
